MEMBER\_NOT\_FOUND\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable MEMBER\_NOT\_FOUND\_ERROR`Const`
=========================================
...
*   Defined in [src/constants.ts:37](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/constants.ts#L37)
