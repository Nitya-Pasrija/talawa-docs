sender | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [sender](resolvers_GroupChatMessage_sender.sender.html)

Variable sender`Const`
======================

sender: [GroupChatMessageResolvers](../types/types_generatedGraphQLTypes.GroupChatMessageResolvers.html)\["sender"\] = ...
...
An object that will contain the User data.

*   Defined in [src/resolvers/GroupChatMessage/sender.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/GroupChatMessage/sender.ts#L8)
