leaveOrganization | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [leaveOrganization](resolvers_Mutation_leaveOrganization.leaveOrganization.html)

Variable leaveOrganization`Const`
=================================

leaveOrganization: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["leaveOrganization"\] = ...
...
*   Defined in [src/resolvers/Mutation/leaveOrganization.ts:21](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Mutation/leaveOrganization.ts#L21)
