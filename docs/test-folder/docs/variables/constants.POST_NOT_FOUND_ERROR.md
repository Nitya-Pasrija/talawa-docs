POST\_NOT\_FOUND\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable POST\_NOT\_FOUND\_ERROR`Const`
=======================================
...
*   Defined in [src/constants.ts:76](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/constants.ts#L76)
