assignUserTag | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [assignUserTag](resolvers_Mutation_assignUserTag.assignUserTag.html)

Variable assignUserTag`Const`
=============================

assignUserTag: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["assignUserTag"\] = ...

*   Defined in [src/resolvers/Mutation/assignUserTag.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Mutation/assignUserTag.ts#L12)
