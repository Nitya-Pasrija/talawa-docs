scalars | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [scalars](typeDefs_scalars.scalars.html)

Variable scalars`Const`
=======================

scalars: DocumentNode = ...

*   Defined in [src/typeDefs/scalars.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/typeDefs/scalars.ts#L4)
