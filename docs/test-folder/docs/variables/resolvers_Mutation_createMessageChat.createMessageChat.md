createMessageChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createMessageChat](resolvers_Mutation_createMessageChat.createMessageChat.html)

Variable createMessageChat`Const`
=================================

createMessageChat: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createMessageChat"\] = ...
...
Created message chat.

*   Defined in [src/resolvers/Mutation/createMessageChat.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Mutation/createMessageChat.ts#L15)
