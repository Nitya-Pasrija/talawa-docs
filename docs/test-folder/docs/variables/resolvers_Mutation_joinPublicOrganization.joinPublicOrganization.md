joinPublicOrganization | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [joinPublicOrganization](resolvers_Mutation_joinPublicOrganization.joinPublicOrganization.html)

Variable joinPublicOrganization`Const`
======================================

joinPublicOrganization: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["joinPublicOrganization"\] = ...
...
*   Defined in [src/resolvers/Mutation/joinPublicOrganization.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Mutation/joinPublicOrganization.ts#L22)
