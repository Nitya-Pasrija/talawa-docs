removeGroupChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeGroupChat](resolvers_Mutation_removeGroupChat.removeGroupChat.html)

Variable removeGroupChat`Const`
===============================

removeGroupChat: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeGroupChat"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeGroupChat.ts:20](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Mutation/removeGroupChat.ts#L20)
