saveFcmToken | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [saveFcmToken](resolvers_Mutation_saveFcmToken.saveFcmToken.html)

Variable saveFcmToken`Const`
============================

saveFcmToken: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["saveFcmToken"\] = ...
...
*   Defined in [src/resolvers/Mutation/saveFcmToken.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Mutation/saveFcmToken.ts#L14)
