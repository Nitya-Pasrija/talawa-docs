groupChatMessageBelongsTo | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [groupChatMessageBelongsTo](resolvers_GroupChatMessage_groupChatMessageBelongsTo.groupChatMessageBelongsTo.html)

Variable groupChatMessageBelongsTo`Const`
=========================================

groupChatMessageBelongsTo: [GroupChatMessageResolvers](../types/types_generatedGraphQLTypes.GroupChatMessageResolvers.html)\["groupChatMessageBelongsTo"\] = ...
...
An object that contains the Group chat data.

*   Defined in [src/resolvers/GroupChatMessage/groupChatMessageBelongsTo.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/GroupChatMessage/groupChatMessageBelongsTo.ts#L8)
