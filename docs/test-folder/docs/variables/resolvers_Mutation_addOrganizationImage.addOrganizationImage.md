addOrganizationImage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [addOrganizationImage](resolvers_Mutation_addOrganizationImage.addOrganizationImage.html)

Variable addOrganizationImage`Const`
====================================

addOrganizationImage: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["addOrganizationImage"\] = ...
...
*   Defined in [src/resolvers/Mutation/addOrganizationImage.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Mutation/addOrganizationImage.ts#L22)
