...
*   [organization](resolvers_DirectChat_organization.organization.html)

Variable organization`Const`
============================

organization: [DirectChatResolvers](../types/types_generatedGraphQLTypes.DirectChatResolvers.html)\["organization"\] = ...
...
*   Defined in [src/resolvers/DirectChat/organization.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/DirectChat/organization.ts#L8)
