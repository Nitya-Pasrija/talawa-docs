membershipRequests | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [membershipRequests](resolvers_Organization_membershipRequests.membershipRequests.html)

Variable membershipRequests`Const`
==================================

membershipRequests: [OrganizationResolvers](../types/types_generatedGraphQLTypes.OrganizationResolvers.html)\["membershipRequests"\] = ...
...
An object that contains the list of membership requests for the organization.

*   Defined in [src/resolvers/Organization/membershipRequests.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Organization/membershipRequests.ts#L8)
