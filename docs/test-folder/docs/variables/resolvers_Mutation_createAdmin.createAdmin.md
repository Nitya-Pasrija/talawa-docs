createAdmin | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createAdmin](resolvers_Mutation_createAdmin.createAdmin.html)

Variable createAdmin`Const`
===========================

createAdmin: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createAdmin"\] = ...
...
*   Defined in [src/resolvers/Mutation/createAdmin.ts:24](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Mutation/createAdmin.ts#L24)
