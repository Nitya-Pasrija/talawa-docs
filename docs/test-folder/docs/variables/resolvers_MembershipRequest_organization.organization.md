...
*   [organization](resolvers_MembershipRequest_organization.organization.html)

Variable organization`Const`
============================

organization: [MembershipRequestResolvers](../types/types_generatedGraphQLTypes.MembershipRequestResolvers.html)\["organization"\] = ...
...
An object that contains the Organization data.

*   Defined in [src/resolvers/MembershipRequest/organization.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/MembershipRequest/organization.ts#L8)
