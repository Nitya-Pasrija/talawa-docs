removeAdmin | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeAdmin](resolvers_Mutation_removeAdmin.removeAdmin.html)

Variable removeAdmin`Const`
===========================

removeAdmin: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeAdmin"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeAdmin.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Mutation/removeAdmin.ts#L22)
