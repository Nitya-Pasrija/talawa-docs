MEMBERSHIP\_REQUEST\_NOT\_FOUND\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable MEMBERSHIP\_REQUEST\_NOT\_FOUND\_ERROR`Const`
======================================================
...
*   Defined in [src/constants.ts:43](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/constants.ts#L43)
