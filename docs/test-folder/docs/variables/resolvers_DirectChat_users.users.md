users | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [users](resolvers_DirectChat_users.users.html)

Variable users`Const`
=====================

users: [DirectChatResolvers](../types/types_generatedGraphQLTypes.DirectChatResolvers.html)\["users"\] = ...
...
*   Defined in [src/resolvers/DirectChat/users.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/DirectChat/users.ts#L8)
