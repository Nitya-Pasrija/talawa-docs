UNAUTHENTICATED\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable UNAUTHENTICATED\_ERROR`Const`
======================================
...
*   Defined in [src/constants.ts:107](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/constants.ts#L107)
