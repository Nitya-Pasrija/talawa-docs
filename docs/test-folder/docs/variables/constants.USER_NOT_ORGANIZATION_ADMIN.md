USER\_NOT\_ORGANIZATION\_ADMIN | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable USER\_NOT\_ORGANIZATION\_ADMIN`Const`
==============================================
...
*   Defined in [src/constants.ts:137](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/constants.ts#L137)
