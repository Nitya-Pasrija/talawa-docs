organizationsConnection | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [organizationsConnection](resolvers_Query_organizationsConnection.organizationsConnection.html)

Variable organizationsConnection`Const`
=======================================

organizationsConnection: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["organizationsConnection"\] = ...
...
*   Defined in [src/resolvers/Query/organizationsConnection.ts:18](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Query/organizationsConnection.ts#L18)
