messages | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [messages](resolvers_GroupChat_messages.messages.html)

Variable messages`Const`
========================

messages: [GroupChatResolvers](../types/types_generatedGraphQLTypes.GroupChatResolvers.html)\["messages"\] = ...
...
An object that contains the list of group chat messages.

*   Defined in [src/resolvers/GroupChat/messages.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/GroupChat/messages.ts#L8)
