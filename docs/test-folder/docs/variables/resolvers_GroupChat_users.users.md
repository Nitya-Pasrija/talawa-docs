...
*   [users](resolvers_GroupChat_users.users.html)

Variable users`Const`
=====================

users: [GroupChatResolvers](../types/types_generatedGraphQLTypes.GroupChatResolvers.html)\["users"\] = ...
...
*   Defined in [src/resolvers/GroupChat/users.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/GroupChat/users.ts#L8)
