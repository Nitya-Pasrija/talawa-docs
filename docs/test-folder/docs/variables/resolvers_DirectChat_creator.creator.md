...
*   [creator](resolvers_DirectChat_creator.creator.html)

Variable creator`Const`
=======================

creator: [DirectChatResolvers](../types/types_generatedGraphQLTypes.DirectChatResolvers.html)\["creator"\] = ...
...
*   Defined in [src/resolvers/DirectChat/creator.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/DirectChat/creator.ts#L8)
