...
*   [sender](resolvers_DirectChatMessage_sender.sender.html)

Variable sender`Const`
======================

sender: [DirectChatMessageResolvers](../types/types_generatedGraphQLTypes.DirectChatMessageResolvers.html)\["sender"\] = ...
...
*   Defined in [src/resolvers/DirectChatMessage/sender.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/DirectChatMessage/sender.ts#L8)
