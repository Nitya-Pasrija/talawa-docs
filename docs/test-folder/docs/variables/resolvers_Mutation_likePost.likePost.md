likePost | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [likePost](resolvers_Mutation_likePost.likePost.html)

Variable likePost`Const`
========================

likePost: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["likePost"\] = ...
...
*   Defined in [src/resolvers/Mutation/likePost.ts:16](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Mutation/likePost.ts#L16)
