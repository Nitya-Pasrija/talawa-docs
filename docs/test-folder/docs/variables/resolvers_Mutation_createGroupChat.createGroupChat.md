createGroupChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createGroupChat](resolvers_Mutation_createGroupChat.createGroupChat.html)

Variable createGroupChat`Const`
===============================

createGroupChat: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createGroupChat"\] = ...
...
*   Defined in [src/resolvers/Mutation/createGroupChat.ts:18](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Mutation/createGroupChat.ts#L18)
