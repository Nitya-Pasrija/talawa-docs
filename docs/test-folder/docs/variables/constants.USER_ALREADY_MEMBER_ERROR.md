USER\_ALREADY\_MEMBER\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable USER\_ALREADY\_MEMBER\_ERROR`Const`
============================================
...
*   Defined in [src/constants.ts:250](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/constants.ts#L250)
