logout | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [logout](resolvers_Mutation_logout.logout.html)

Variable logout`Const`
======================

logout: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["logout"\] = ...
...
*   Defined in [src/resolvers/Mutation/logout.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Mutation/logout.ts#L14)
