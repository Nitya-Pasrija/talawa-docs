updatePluginStatus | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [updatePluginStatus](resolvers_Mutation_updatePluginStatus.updatePluginStatus.html)

Variable updatePluginStatus`Const`
==================================

updatePluginStatus: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["updatePluginStatus"\] = ...
...
*   Defined in [src/resolvers/Mutation/updatePluginStatus.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Mutation/updatePluginStatus.ts#L12)
