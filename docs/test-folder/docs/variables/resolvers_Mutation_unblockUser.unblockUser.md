unblockUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [unblockUser](resolvers_Mutation_unblockUser.unblockUser.html)

Variable unblockUser`Const`
===========================

unblockUser: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["unblockUser"\] = ...
...
*   Defined in [src/resolvers/Mutation/unblockUser.ts:21](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Mutation/unblockUser.ts#L21)
