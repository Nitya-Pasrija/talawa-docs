admins | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [admins](resolvers_Organization_admins.admins.html)

Variable admins`Const`
======================

admins: [OrganizationResolvers](../types/types_generatedGraphQLTypes.OrganizationResolvers.html)\["admins"\] = ...
...
An object that contains the list of all admins of the organization.

*   Defined in [src/resolvers/Organization/admins.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Organization/admins.ts#L8)
