sendMessageToGroupChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [sendMessageToGroupChat](resolvers_Mutation_sendMessageToGroupChat.sendMessageToGroupChat.html)

Variable sendMessageToGroupChat`Const`
======================================

sendMessageToGroupChat: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["sendMessageToGroupChat"\] = ...
...
*   Defined in [src/resolvers/Mutation/sendMessageToGroupChat.ts:20](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Mutation/sendMessageToGroupChat.ts#L20)
