REGEX\_VALIDATION\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable REGEX\_VALIDATION\_ERROR`Const`
========================================
...
*   Defined in [src/constants.ts:119](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/constants.ts#L119)
