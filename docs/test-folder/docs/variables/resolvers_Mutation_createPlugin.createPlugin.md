createPlugin | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createPlugin](resolvers_Mutation_createPlugin.createPlugin.html)

Variable createPlugin`Const`
============================

createPlugin: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createPlugin"\] = ...
...
*   Defined in [src/resolvers/Mutation/createPlugin.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Mutation/createPlugin.ts#L12)
