COMMENT\_NOT\_FOUND\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable COMMENT\_NOT\_FOUND\_ERROR`Const`
==========================================
...
*   Defined in [src/constants.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/constants.ts#L15)
