adminRemoveEvent | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [adminRemoveEvent](resolvers_Mutation_adminRemoveEvent.adminRemoveEvent.html)

Variable adminRemoveEvent`Const`
================================

adminRemoveEvent: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["adminRemoveEvent"\] = ...
...
*   Defined in [src/resolvers/Mutation/adminRemoveEvent.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Mutation/adminRemoveEvent.ts#L22)
