...
*   Defined in [src/resolvers/MembershipRequest/user.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/MembershipRequest/user.ts#L8)
