user | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [user](resolvers_MembershipRequest_user.user.html)

Variable user`Const`
====================

user: [MembershipRequestResolvers](../types/types_generatedGraphQLTypes.MembershipRequestResolvers.html)\["user"\] = ...
...
*   Defined in [src/resolvers/MembershipRequest/user.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/MembershipRequest/user.ts#L8)
