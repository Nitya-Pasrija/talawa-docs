messageSentToDirectChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [messageSentToDirectChat](resolvers_Subscription_messageSentToDirectChat.messageSentToDirectChat.html)

Variable messageSentToDirectChat`Const`
=======================================

messageSentToDirectChat: [SubscriptionResolvers](../types/types_generatedGraphQLTypes.SubscriptionResolvers.html)\["messageSentToDirectChat"\] = ...

This property included a `subscribe` method, which is used to subscribe the `receiver` and `sender` to receive Direct Chat updates.
...
*   Defined in [src/resolvers/Subscription/messageSentToDirectChat.ts:21](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Subscription/messageSentToDirectChat.ts#L21)
