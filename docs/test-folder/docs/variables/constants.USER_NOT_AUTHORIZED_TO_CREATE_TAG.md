USER\_NOT\_AUTHORIZED\_TO\_CREATE\_TAG | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable USER\_NOT\_AUTHORIZED\_TO\_CREATE\_TAG`Const`
======================================================
...
*   Defined in [src/constants.ts:215](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/constants.ts#L215)
