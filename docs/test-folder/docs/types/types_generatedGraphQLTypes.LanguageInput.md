LanguageInput | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
LanguageInput: {  
    en\_value: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    translation\_lang\_code: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    translation\_value: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:316](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L316)
