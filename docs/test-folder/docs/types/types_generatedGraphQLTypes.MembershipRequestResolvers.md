MembershipRequestResolvers | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
MembershipRequestResolvers<ContextType, ParentType\>: {  
...
*   #### ParentType extends [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["MembershipRequest"\] = [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["MembershipRequest"\]
...
*   Defined in [src/types/generatedGraphQLTypes.ts:2032](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L2032)
