ToggleUserTagAssignInput | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    tagId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1322](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L1322)
