Plugin | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    installedOrgs: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]\[\];  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:960](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L960)
