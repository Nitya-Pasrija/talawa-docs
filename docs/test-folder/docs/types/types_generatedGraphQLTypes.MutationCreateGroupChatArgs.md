MutationCreateGroupChatArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    data: [CreateGroupChatInput](types_generatedGraphQLTypes.CreateGroupChatInput.html);  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:543](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L543)
