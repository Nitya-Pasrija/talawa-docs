QueryIsUserRegisterArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Type alias QueryIsUserRegisterArgs
==================================
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1166](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L1166)
