MutationCreateCommentArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    data: [CommentInput](types_generatedGraphQLTypes.CommentInput.html);  
    postId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:517](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L517)
