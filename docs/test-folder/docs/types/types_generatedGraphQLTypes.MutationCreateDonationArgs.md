MutationCreateDonationArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    payPalId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:528](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L528)
