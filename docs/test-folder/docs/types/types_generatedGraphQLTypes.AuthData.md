AuthData | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
AuthData: {  
    \_\_typename?: "AuthData";  
    accessToken: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
...
    refreshToken: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:65](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L65)
