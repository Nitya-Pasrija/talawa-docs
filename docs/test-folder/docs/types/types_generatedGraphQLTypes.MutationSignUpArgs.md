MutationSignUpArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
MutationSignUpArgs: {  
    data: [UserInput](types_generatedGraphQLTypes.UserInput.html);  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:744](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L744)
