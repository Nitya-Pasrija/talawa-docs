MutationCreateOrganizationArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[OrganizationInput](types_generatedGraphQLTypes.OrganizationInput.html)\>;  
    file?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>;  
}

#### Type declaration

*   ##### `Optional` data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[OrganizationInput](types_generatedGraphQLTypes.OrganizationInput.html)\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:558](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L558)
