MutationUpdatePostArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[PostUpdateInput](types_generatedGraphQLTypes.PostUpdateInput.html)\>;  
    id: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
}

#### Type declaration

*   ##### `Optional` data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[PostUpdateInput](types_generatedGraphQLTypes.PostUpdateInput.html)\>
    
*   ##### id: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]
    

*   Defined in [src/types/generatedGraphQLTypes.ts:811](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L811)
