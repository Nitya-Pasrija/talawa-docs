MutationCreateDirectChatArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    data: [CreateChatInput](types_generatedGraphQLTypes.CreateChatInput.html);  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:523](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L523)
