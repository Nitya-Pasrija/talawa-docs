UserTagsConnection | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
UserTagsConnection: {  
    \_\_typename?: "UserTagsConnection";  
    edges?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTagEdge](types_generatedGraphQLTypes.UserTagEdge.html)\>\[\]\>;  
...
*   ##### `Optional` edges?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTagEdge](types_generatedGraphQLTypes.UserTagEdge.html)\>\[\]\>
    
*   ##### pageInfo: [ConnectionPageInfo](types_generatedGraphQLTypes.ConnectionPageInfo.html)
    

*   Defined in [src/types/generatedGraphQLTypes.ts:1506](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L1506)
