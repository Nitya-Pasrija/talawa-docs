MutationUpdateOrganizationArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[UpdateOrganizationInput](types_generatedGraphQLTypes.UpdateOrganizationInput.html)\>;  
    file?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>;  
    id: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
}

#### Type declaration

*   ##### `Optional` data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[UpdateOrganizationInput](types_generatedGraphQLTypes.UpdateOrganizationInput.html)\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:792](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L792)
