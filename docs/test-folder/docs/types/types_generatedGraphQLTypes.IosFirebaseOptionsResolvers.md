IosFirebaseOptionsResolvers | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Type alias IosFirebaseOptionsResolvers<ContextType, ParentType>
===============================================================

IosFirebaseOptionsResolvers<ContextType, ParentType\>: {  
    \_\_isTypeOf?: [IsTypeOfResolverFn](types_generatedGraphQLTypes.IsTypeOfResolverFn.html)<ParentType, ContextType\>;  
    apiKey?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>;  
    appId?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>;  
    iosBundleId?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>;  
    iosClientId?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>;  
    messagingSenderId?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>;  
    projectId?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>;  
    storageBucket?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>;  
}
...
*   #### ParentType extends [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["IOSFirebaseOptions"\] = [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["IOSFirebaseOptions"\]
...
*   ##### `Optional` apiKey?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>
    
*   ##### `Optional` appId?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>
    
*   ##### `Optional` iosBundleId?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>
    
*   ##### `Optional` iosClientId?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>
    
*   ##### `Optional` messagingSenderId?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>
    
*   ##### `Optional` projectId?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>
    
*   ##### `Optional` storageBucket?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\]\>, ParentType, ContextType\>
    

*   Defined in [src/types/generatedGraphQLTypes.ts:1996](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L1996)
