Donation | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Donation: {  
    \_\_typename?: "Donation";  
    \_id: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
    amount: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Float"\];  
    nameOfOrg: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    nameOfUser: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    orgId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
    payPalId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:127](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L127)
