Task | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    createdAt: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["DateTime"\];  
    creator: [User](types_generatedGraphQLTypes.User.html);  
    deadline?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["DateTime"\]\>;  
    description?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>;  
    event: [Event](types_generatedGraphQLTypes.Event.html);  
    title: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
}

#### Type declaration

*   ##### `Optional` \_\_typename?: "Task"
...
*   ##### `Optional` deadline?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["DateTime"\]\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1293](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L1293)
