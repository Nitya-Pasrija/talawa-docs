UserTagEdgeResolvers | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Type alias UserTagEdgeResolvers<ContextType, ParentType>
========================================================

UserTagEdgeResolvers<ContextType, ParentType\>: {  
    \_\_isTypeOf?: [IsTypeOfResolverFn](types_generatedGraphQLTypes.IsTypeOfResolverFn.html)<ParentType, ContextType\>;  
    cursor?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\], ParentType, ContextType\>;  
    node?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["UserTag"\], ParentType, ContextType\>;  
}
...
*   #### ParentType extends [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["UserTagEdge"\] = [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["UserTagEdge"\]
...
*   ##### `Optional` cursor?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\], ParentType, ContextType\>
    
*   ##### `Optional` node?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["UserTag"\], ParentType, ContextType\>
    

*   Defined in [src/types/generatedGraphQLTypes.ts:2357](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L2357)
