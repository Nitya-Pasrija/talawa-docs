MutationAcceptAdminArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Type alias MutationAcceptAdminArgs
==================================
...
*   Defined in [src/types/generatedGraphQLTypes.ts:448](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L448)
