PostInput | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
PostInput: {  
    \_id?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]\>;  
    imageUrl?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["URL"\]\>;  
    organizationId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
    pinned?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\]\>;  
...
    videoUrl?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["URL"\]\>;  
}

#### Type declaration

*   ##### `Optional` \_id?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]\>
    
*   ##### `Optional` imageUrl?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["URL"\]\>
    
*   ##### organizationId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]
    
*   ##### `Optional` pinned?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\]\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1017](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L1017)
