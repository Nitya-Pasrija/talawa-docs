MutationAddLanguageTranslationArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    data: [LanguageInput](types_generatedGraphQLTypes.LanguageInput.html);  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:458](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L458)
