OrganizationInfoNodeResolvers | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
OrganizationInfoNodeResolvers<ContextType, ParentType\>: {  
...
*   #### ParentType extends [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["OrganizationInfoNode"\] = [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["OrganizationInfoNode"\]
...
*   Defined in [src/types/generatedGraphQLTypes.ts:2157](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L2157)
