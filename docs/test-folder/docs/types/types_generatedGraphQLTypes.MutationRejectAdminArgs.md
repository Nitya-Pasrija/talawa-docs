MutationRejectAdminArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Type alias MutationRejectAdminArgs
==================================
...
*   Defined in [src/types/generatedGraphQLTypes.ts:645](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L645)
