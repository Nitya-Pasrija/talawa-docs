UserConnection | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
UserConnection: {  
    \_\_typename?: "UserConnection";  
    aggregate: [AggregateUser](types_generatedGraphQLTypes.AggregateUser.html);  
    edges: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[User](types_generatedGraphQLTypes.User.html)\>\[\];  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1440](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L1440)
