ForgotPasswordData | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    userOtp: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:263](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L263)
