AggregatePostResolvers | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
AggregatePostResolvers<ContextType, ParentType\>: {  
...
*   #### ParentType extends [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["AggregatePost"\] = [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["AggregatePost"\]
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1837](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/types/generatedGraphQLTypes.ts#L1837)
