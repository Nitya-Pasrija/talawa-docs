MutationUpdateTaskArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Type alias MutationUpdateTaskArgs
=================================

MutationUpdateTaskArgs: {  
    data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[UpdateTaskInput](types_generatedGraphQLTypes.UpdateTaskInput.html)\>;  
    id: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
}

#### Type declaration

*   ##### `Optional` data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[UpdateTaskInput](types_generatedGraphQLTypes.UpdateTaskInput.html)\>
    
*   ##### id: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]
    

*   Defined in [src/types/generatedGraphQLTypes.ts:817](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/types/generatedGraphQLTypes.ts#L817)
