setRequestContextValue | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [setRequestContextValue](libraries_requestContext.setRequestContextValue.html)

Function setRequestContextValue
===============================

*   setRequestContextValue<T\>(key, value): T[](#setRequestContextValue)
*   #### Type Parameters
    ...
    *   Defined in [src/libraries/requestContext.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/libraries/requestContext.ts#L14)
...
*   [libraries/requestContext](../modules/libraries_requestContext.html)
    ...
    *   [getRequestContextValue](libraries_requestContext.getRequestContextValue.html)
    *   [init](libraries_requestContext.init.html)
    *   [middleware](libraries_requestContext.middleware.html)
    *   [setRequestContext](libraries_requestContext.setRequestContext.html)
    *   [setRequestContextValue](libraries_requestContext.setRequestContextValue.html)
    *   [translate](libraries_requestContext.translate.html)
    *   [translatePlural](libraries_requestContext.translatePlural.html)
