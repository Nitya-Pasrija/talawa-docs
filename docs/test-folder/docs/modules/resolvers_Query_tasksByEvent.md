resolvers/Query/tasksByEvent | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/tasksByEvent.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Query/tasksByEvent.ts#L1)

### Index

### Variables

[tasksByEvent](../variables/resolvers_Query_tasksByEvent.tasksByEvent.html)
