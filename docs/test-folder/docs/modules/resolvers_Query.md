resolvers/Query | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/index.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Query/index.ts#L1)

### Index

### Variables

[Query](../variables/resolvers_Query.Query.html)
