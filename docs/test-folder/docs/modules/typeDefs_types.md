typeDefs/types | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/typeDefs/types.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/typeDefs/types.ts#L1)

### Index

### Variables

[types](../variables/typeDefs_types.types.html)
