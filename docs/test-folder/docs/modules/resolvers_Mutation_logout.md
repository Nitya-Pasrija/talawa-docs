resolvers/Mutation/logout | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Mutation/logout.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Mutation/logout.ts#L1)

### Index

### Variables

[logout](../variables/resolvers_Mutation_logout.logout.html)
