resolvers/Mutation/login | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Mutation/login.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Mutation/login.ts#L1)

### Index

### Variables

[login](../variables/resolvers_Mutation_login.login.html)
