models/Task | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/models/Task.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/models/Task.ts#L1)

### Index

### Interfaces

[InterfaceTask](../interfaces/models_Task.InterfaceTask.html)
