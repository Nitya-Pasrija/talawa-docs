utilities/deleteImage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/utilities/deleteImage.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/utilities/deleteImage.ts#L1)

### Index

### Functions

[deleteImage](../functions/utilities_deleteImage.deleteImage.html)
