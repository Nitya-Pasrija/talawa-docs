models/MessageChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/models/MessageChat.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/models/MessageChat.ts#L1)

### Index

### Interfaces

[InterfaceMessageChat](../interfaces/models_MessageChat.InterfaceMessageChat.html)
