resolvers/MembershipRequest/user | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/MembershipRequest/user.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/MembershipRequest/user.ts#L1)

### Index

### Variables

[user](../variables/resolvers_MembershipRequest_user.user.html)
