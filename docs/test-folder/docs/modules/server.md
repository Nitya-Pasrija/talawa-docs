server | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/server.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/server.ts#L1)
