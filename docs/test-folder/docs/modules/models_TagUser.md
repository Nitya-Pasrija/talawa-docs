models/TagUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/models/TagUser.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/models/TagUser.ts#L1)

### Index

### Interfaces

[InterfaceTagUser](../interfaces/models_TagUser.InterfaceTagUser.html)
