env | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/env.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/env.ts#L1)

### Index

### Variables

[envSchema](../variables/env.envSchema.html)
