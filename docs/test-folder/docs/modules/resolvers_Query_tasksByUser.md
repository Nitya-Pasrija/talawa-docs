resolvers/Query/tasksByUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/tasksByUser.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/Query/tasksByUser.ts#L1)

### Index

### Variables

[tasksByUser](../variables/resolvers_Query_tasksByUser.tasksByUser.html)
