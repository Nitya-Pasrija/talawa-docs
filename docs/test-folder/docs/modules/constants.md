constants | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/constants.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/constants.ts#L1)

### Index

### Variables

[ACCESS\_TOKEN\_SECRET](../variables/constants.ACCESS_TOKEN_SECRET.html) [ADMIN\_REMOVING\_ADMIN](../variables/constants.ADMIN_REMOVING_ADMIN.html) [ADMIN\_REMOVING\_CREATOR](../variables/constants.ADMIN_REMOVING_CREATOR.html) [BASE\_URL](../variables/constants.BASE_URL.html) [CHAT\_NOT\_FOUND\_ERROR](../variables/constants.CHAT_NOT_FOUND_ERROR.html) [COMMENT\_NOT\_FOUND\_ERROR](../variables/constants.COMMENT_NOT_FOUND_ERROR.html) [EMAIL\_ALREADY\_EXISTS\_ERROR](../variables/constants.EMAIL_ALREADY_EXISTS_ERROR.html) [ERROR\_IN\_SENDING\_MAIL](../variables/constants.ERROR_IN_SENDING_MAIL.html) [EVENT\_NOT\_FOUND\_ERROR](../variables/constants.EVENT_NOT_FOUND_ERROR.html) [EVENT\_PROJECT\_NOT\_FOUND\_ERROR](../variables/constants.EVENT_PROJECT_NOT_FOUND_ERROR.html) [INCORRECT\_TAG\_INPUT](../variables/constants.INCORRECT_TAG_INPUT.html) [INTERNAL\_SERVER\_ERROR](../variables/constants.INTERNAL_SERVER_ERROR.html) [INVALID\_CREDENTIALS\_ERROR](../variables/constants.INVALID_CREDENTIALS_ERROR.html) [INVALID\_FILE\_TYPE](../variables/constants.INVALID_FILE_TYPE.html) [INVALID\_OTP](../variables/constants.INVALID_OTP.html) [INVALID\_REFRESH\_TOKEN\_ERROR](../variables/constants.INVALID_REFRESH_TOKEN_ERROR.html) [INVALID\_TAG\_INPUT](../variables/constants.INVALID_TAG_INPUT.html) [IN\_PRODUCTION](../variables/constants.IN_PRODUCTION.html) [LAST\_RESORT\_SUPERADMIN\_EMAIL](../variables/constants.LAST_RESORT_SUPERADMIN_EMAIL.html) [LENGTH\_VALIDATION\_ERROR](../variables/constants.LENGTH_VALIDATION_ERROR.html) [MAIL\_PASSWORD](../variables/constants.MAIL_PASSWORD.html) [MAIL\_USERNAME](../variables/constants.MAIL_USERNAME.html) [MEMBERSHIP\_REQUEST\_ALREADY\_EXISTS](../variables/constants.MEMBERSHIP_REQUEST_ALREADY_EXISTS.html) [MEMBERSHIP\_REQUEST\_NOT\_FOUND\_ERROR](../variables/constants.MEMBERSHIP_REQUEST_NOT_FOUND_ERROR.html) [MEMBER\_NOT\_FOUND\_ERROR](../variables/constants.MEMBER_NOT_FOUND_ERROR.html) [MONGO\_DB\_URL](../variables/constants.MONGO_DB_URL.html) [NO\_CHANGE\_IN\_TAG\_NAME](../variables/constants.NO_CHANGE_IN_TAG_NAME.html) [ORGANIZATION\_IMAGE\_NOT\_FOUND\_ERROR](../variables/constants.ORGANIZATION_IMAGE_NOT_FOUND_ERROR.html) [ORGANIZATION\_MEMBER\_NOT\_FOUND\_ERROR](../variables/constants.ORGANIZATION_MEMBER_NOT_FOUND_ERROR.html) [ORGANIZATION\_NOT\_AUTHORIZED\_ERROR](../variables/constants.ORGANIZATION_NOT_AUTHORIZED_ERROR.html) [ORGANIZATION\_NOT\_FOUND\_ERROR](../variables/constants.ORGANIZATION_NOT_FOUND_ERROR.html) [POST\_NOT\_FOUND\_ERROR](../variables/constants.POST_NOT_FOUND_ERROR.html) [RECAPTCHA\_SECRET\_KEY](../variables/constants.RECAPTCHA_SECRET_KEY.html) [REFRESH\_TOKEN\_SECRET](../variables/constants.REFRESH_TOKEN_SECRET.html) [REGEX\_VALIDATION\_ERROR](../variables/constants.REGEX_VALIDATION_ERROR.html) [REGISTRANT\_ALREADY\_EXIST\_ERROR](../variables/constants.REGISTRANT_ALREADY_EXIST_ERROR.html) [SAME\_FILE\_ERROR](../variables/constants.SAME_FILE_ERROR.html) [SMTP\_OPTIONS](../variables/constants.SMTP_OPTIONS.html) [STATUS\_ACTIVE](../variables/constants.STATUS_ACTIVE.html) [SUPERADMIN\_CANT\_CHANGE\_OWN\_ROLE](../variables/constants.SUPERADMIN_CANT_CHANGE_OWN_ROLE.html) [TAG\_ALREADY\_EXISTS](../variables/constants.TAG_ALREADY_EXISTS.html) [TAG\_NOT\_FOUND](../variables/constants.TAG_NOT_FOUND.html) [TASK\_NOT\_FOUND\_ERROR](../variables/constants.TASK_NOT_FOUND_ERROR.html) [TRANSLATION\_ALREADY\_PRESENT\_ERROR](../variables/constants.TRANSLATION_ALREADY_PRESENT_ERROR.html) [UNAUTHENTICATED\_ERROR](../variables/constants.UNAUTHENTICATED_ERROR.html) [URL](../variables/constants.URL.html) [USER\_ALREADY\_HAS\_TAG](../variables/constants.USER_ALREADY_HAS_TAG.html) [USER\_ALREADY\_MEMBER\_ERROR](../variables/constants.USER_ALREADY_MEMBER_ERROR.html) [USER\_ALREADY\_UNREGISTERED\_ERROR](../variables/constants.USER_ALREADY_UNREGISTERED_ERROR.html) [USER\_BLOCKING\_SELF](../variables/constants.USER_BLOCKING_SELF.html) [USER\_DOES\_NOT\_BELONG\_TO\_TAGS\_ORGANIZATION](../variables/constants.USER_DOES_NOT_BELONG_TO_TAGS_ORGANIZATION.html) [USER\_DOES\_NOT\_HAVE\_THE\_TAG](../variables/constants.USER_DOES_NOT_HAVE_THE_TAG.html) [USER\_NOT\_AUTHORIZED\_ADMIN](../variables/constants.USER_NOT_AUTHORIZED_ADMIN.html) [USER\_NOT\_AUTHORIZED\_ERROR](../variables/constants.USER_NOT_AUTHORIZED_ERROR.html) [USER\_NOT\_AUTHORIZED\_SUPERADMIN](../variables/constants.USER_NOT_AUTHORIZED_SUPERADMIN.html) [USER\_NOT\_AUTHORIZED\_TO\_CREATE\_TAG](../variables/constants.USER_NOT_AUTHORIZED_TO_CREATE_TAG.html) [USER\_NOT\_AUTHORIZED\_TO\_PIN](../variables/constants.USER_NOT_AUTHORIZED_TO_PIN.html) [USER\_NOT\_FOUND\_ERROR](../variables/constants.USER_NOT_FOUND_ERROR.html) [USER\_NOT\_ORGANIZATION\_ADMIN](../variables/constants.USER_NOT_ORGANIZATION_ADMIN.html) [USER\_PROFILE\_IMAGE\_NOT\_FOUND\_ERROR](../variables/constants.USER_PROFILE_IMAGE_NOT_FOUND_ERROR.html) [USER\_REMOVING\_SELF](../variables/constants.USER_REMOVING_SELF.html) [apiKey](../variables/constants.apiKey.html) [appId](../variables/constants.appId.html) [iOSapiKey](../variables/constants.iOSapiKey.html) [iOSappId](../variables/constants.iOSappId.html) [iOSmessagingSenderId](../variables/constants.iOSmessagingSenderId.html) [iOSprojectId](../variables/constants.iOSprojectId.html) [iOSstorageBucket](../variables/constants.iOSstorageBucket.html) [iosBundleId](../variables/constants.iosBundleId.html) [iosClientId](../variables/constants.iosClientId.html) [messagingSenderId](../variables/constants.messagingSenderId.html) [projectId](../variables/constants.projectId.html) [storageBucket](../variables/constants.storageBucket.html)
...
*   [constants](constants.html)
    ...
    *   [ACCESS\_TOKEN\_SECRET](../variables/constants.ACCESS_TOKEN_SECRET.html)
    *   [ADMIN\_REMOVING\_ADMIN](../variables/constants.ADMIN_REMOVING_ADMIN.html)
    *   [ADMIN\_REMOVING\_CREATOR](../variables/constants.ADMIN_REMOVING_CREATOR.html)
    *   [BASE\_URL](../variables/constants.BASE_URL.html)
    *   [CHAT\_NOT\_FOUND\_ERROR](../variables/constants.CHAT_NOT_FOUND_ERROR.html)
    *   [COMMENT\_NOT\_FOUND\_ERROR](../variables/constants.COMMENT_NOT_FOUND_ERROR.html)
    *   [EMAIL\_ALREADY\_EXISTS\_ERROR](../variables/constants.EMAIL_ALREADY_EXISTS_ERROR.html)
    *   [ERROR\_IN\_SENDING\_MAIL](../variables/constants.ERROR_IN_SENDING_MAIL.html)
    *   [EVENT\_NOT\_FOUND\_ERROR](../variables/constants.EVENT_NOT_FOUND_ERROR.html)
    *   [EVENT\_PROJECT\_NOT\_FOUND\_ERROR](../variables/constants.EVENT_PROJECT_NOT_FOUND_ERROR.html)
    *   [INCORRECT\_TAG\_INPUT](../variables/constants.INCORRECT_TAG_INPUT.html)
    *   [INTERNAL\_SERVER\_ERROR](../variables/constants.INTERNAL_SERVER_ERROR.html)
    *   [INVALID\_CREDENTIALS\_ERROR](../variables/constants.INVALID_CREDENTIALS_ERROR.html)
    *   [INVALID\_FILE\_TYPE](../variables/constants.INVALID_FILE_TYPE.html)
    *   [INVALID\_OTP](../variables/constants.INVALID_OTP.html)
    *   [INVALID\_REFRESH\_TOKEN\_ERROR](../variables/constants.INVALID_REFRESH_TOKEN_ERROR.html)
    *   [INVALID\_TAG\_INPUT](../variables/constants.INVALID_TAG_INPUT.html)
    *   [IN\_PRODUCTION](../variables/constants.IN_PRODUCTION.html)
    *   [LAST\_RESORT\_SUPERADMIN\_EMAIL](../variables/constants.LAST_RESORT_SUPERADMIN_EMAIL.html)
    *   [LENGTH\_VALIDATION\_ERROR](../variables/constants.LENGTH_VALIDATION_ERROR.html)
    *   [MAIL\_PASSWORD](../variables/constants.MAIL_PASSWORD.html)
    *   [MAIL\_USERNAME](../variables/constants.MAIL_USERNAME.html)
    *   [MEMBERSHIP\_REQUEST\_ALREADY\_EXISTS](../variables/constants.MEMBERSHIP_REQUEST_ALREADY_EXISTS.html)
    *   [MEMBERSHIP\_REQUEST\_NOT\_FOUND\_ERROR](../variables/constants.MEMBERSHIP_REQUEST_NOT_FOUND_ERROR.html)
    *   [MEMBER\_NOT\_FOUND\_ERROR](../variables/constants.MEMBER_NOT_FOUND_ERROR.html)
    *   [MONGO\_DB\_URL](../variables/constants.MONGO_DB_URL.html)
    *   [NO\_CHANGE\_IN\_TAG\_NAME](../variables/constants.NO_CHANGE_IN_TAG_NAME.html)
    *   [ORGANIZATION\_IMAGE\_NOT\_FOUND\_ERROR](../variables/constants.ORGANIZATION_IMAGE_NOT_FOUND_ERROR.html)
    *   [ORGANIZATION\_MEMBER\_NOT\_FOUND\_ERROR](../variables/constants.ORGANIZATION_MEMBER_NOT_FOUND_ERROR.html)
    *   [ORGANIZATION\_NOT\_AUTHORIZED\_ERROR](../variables/constants.ORGANIZATION_NOT_AUTHORIZED_ERROR.html)
    *   [ORGANIZATION\_NOT\_FOUND\_ERROR](../variables/constants.ORGANIZATION_NOT_FOUND_ERROR.html)
    *   [POST\_NOT\_FOUND\_ERROR](../variables/constants.POST_NOT_FOUND_ERROR.html)
    *   [RECAPTCHA\_SECRET\_KEY](../variables/constants.RECAPTCHA_SECRET_KEY.html)
    *   [REFRESH\_TOKEN\_SECRET](../variables/constants.REFRESH_TOKEN_SECRET.html)
    *   [REGEX\_VALIDATION\_ERROR](../variables/constants.REGEX_VALIDATION_ERROR.html)
    *   [REGISTRANT\_ALREADY\_EXIST\_ERROR](../variables/constants.REGISTRANT_ALREADY_EXIST_ERROR.html)
    *   [SAME\_FILE\_ERROR](../variables/constants.SAME_FILE_ERROR.html)
    *   [SMTP\_OPTIONS](../variables/constants.SMTP_OPTIONS.html)
    *   [STATUS\_ACTIVE](../variables/constants.STATUS_ACTIVE.html)
    *   [SUPERADMIN\_CANT\_CHANGE\_OWN\_ROLE](../variables/constants.SUPERADMIN_CANT_CHANGE_OWN_ROLE.html)
    *   [TAG\_ALREADY\_EXISTS](../variables/constants.TAG_ALREADY_EXISTS.html)
    *   [TAG\_NOT\_FOUND](../variables/constants.TAG_NOT_FOUND.html)
    *   [TASK\_NOT\_FOUND\_ERROR](../variables/constants.TASK_NOT_FOUND_ERROR.html)
    *   [TRANSLATION\_ALREADY\_PRESENT\_ERROR](../variables/constants.TRANSLATION_ALREADY_PRESENT_ERROR.html)
    *   [UNAUTHENTICATED\_ERROR](../variables/constants.UNAUTHENTICATED_ERROR.html)
    *   [URL](../variables/constants.URL.html)
    *   [USER\_ALREADY\_HAS\_TAG](../variables/constants.USER_ALREADY_HAS_TAG.html)
    *   [USER\_ALREADY\_MEMBER\_ERROR](../variables/constants.USER_ALREADY_MEMBER_ERROR.html)
    *   [USER\_ALREADY\_UNREGISTERED\_ERROR](../variables/constants.USER_ALREADY_UNREGISTERED_ERROR.html)
    *   [USER\_BLOCKING\_SELF](../variables/constants.USER_BLOCKING_SELF.html)
    *   [USER\_DOES\_NOT\_BELONG\_TO\_TAGS\_ORGANIZATION](../variables/constants.USER_DOES_NOT_BELONG_TO_TAGS_ORGANIZATION.html)
    *   [USER\_DOES\_NOT\_HAVE\_THE\_TAG](../variables/constants.USER_DOES_NOT_HAVE_THE_TAG.html)
    *   [USER\_NOT\_AUTHORIZED\_ADMIN](../variables/constants.USER_NOT_AUTHORIZED_ADMIN.html)
    *   [USER\_NOT\_AUTHORIZED\_ERROR](../variables/constants.USER_NOT_AUTHORIZED_ERROR.html)
    *   [USER\_NOT\_AUTHORIZED\_SUPERADMIN](../variables/constants.USER_NOT_AUTHORIZED_SUPERADMIN.html)
    *   [USER\_NOT\_AUTHORIZED\_TO\_CREATE\_TAG](../variables/constants.USER_NOT_AUTHORIZED_TO_CREATE_TAG.html)
    *   [USER\_NOT\_AUTHORIZED\_TO\_PIN](../variables/constants.USER_NOT_AUTHORIZED_TO_PIN.html)
    *   [USER\_NOT\_FOUND\_ERROR](../variables/constants.USER_NOT_FOUND_ERROR.html)
    *   [USER\_NOT\_ORGANIZATION\_ADMIN](../variables/constants.USER_NOT_ORGANIZATION_ADMIN.html)
    *   [USER\_PROFILE\_IMAGE\_NOT\_FOUND\_ERROR](../variables/constants.USER_PROFILE_IMAGE_NOT_FOUND_ERROR.html)
    *   [USER\_REMOVING\_SELF](../variables/constants.USER_REMOVING_SELF.html)
    *   [apiKey](../variables/constants.apiKey.html)
    *   [appId](../variables/constants.appId.html)
    *   [iOSapiKey](../variables/constants.iOSapiKey.html)
    *   [iOSappId](../variables/constants.iOSappId.html)
    *   [iOSmessagingSenderId](../variables/constants.iOSmessagingSenderId.html)
    *   [iOSprojectId](../variables/constants.iOSprojectId.html)
    *   [iOSstorageBucket](../variables/constants.iOSstorageBucket.html)
    *   [iosBundleId](../variables/constants.iosBundleId.html)
    *   [iosClientId](../variables/constants.iosClientId.html)
    *   [messagingSenderId](../variables/constants.messagingSenderId.html)
    *   [projectId](../variables/constants.projectId.html)
    *   [storageBucket](../variables/constants.storageBucket.html)
