resolvers/GroupChat/users | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/GroupChat/users.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/resolvers/GroupChat/users.ts#L1)

### Index

### Variables

[users](../variables/resolvers_GroupChat_users.users.html)
