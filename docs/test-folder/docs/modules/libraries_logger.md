libraries/logger | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/libraries/logger.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/libraries/logger.ts#L1)

### Index

### Variables

[logger](../variables/libraries_logger.logger.html) [stream](../variables/libraries_logger.stream.html)
...
*   [libraries/logger](libraries_logger.html)
    ...
    *   [logger](../variables/libraries_logger.logger.html)
    *   [stream](../variables/libraries_logger.stream.html)
