resolvers/Query/myLanguage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/myLanguage.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/resolvers/Query/myLanguage.ts#L1)

### Index

### Variables

[myLanguage](../variables/resolvers_Query_myLanguage.myLanguage.html)
