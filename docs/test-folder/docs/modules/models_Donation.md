models/Donation | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/models/Donation.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/6058ae7/src/models/Donation.ts#L1)

### Index

### Interfaces

[InterfaceDonation](../interfaces/models_Donation.InterfaceDonation.html)
