typeDefs/inputs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/typeDefs/inputs.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/typeDefs/inputs.ts#L1)

### Index

### Variables

[inputs](../variables/typeDefs_inputs.inputs.html)
