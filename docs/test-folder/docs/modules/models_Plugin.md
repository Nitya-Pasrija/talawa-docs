models/Plugin | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/models/Plugin.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/68139af/src/models/Plugin.ts#L1)

### Index

### Interfaces

[InterfacePlugin](../interfaces/models_Plugin.InterfacePlugin.html)
