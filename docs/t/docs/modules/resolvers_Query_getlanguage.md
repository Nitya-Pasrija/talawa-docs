resolvers/Query/getlanguage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/getlanguage.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/getlanguage.ts#L1)

### Index

### Variables

[getlanguage](../variables/resolvers_Query_getlanguage.getlanguage.html)
