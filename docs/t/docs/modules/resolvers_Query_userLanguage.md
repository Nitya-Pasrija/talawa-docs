resolvers/Query/userLanguage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/userLanguage.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/userLanguage.ts#L1)

### Index

### Variables

[userLanguage](../variables/resolvers_Query_userLanguage.userLanguage.html)
