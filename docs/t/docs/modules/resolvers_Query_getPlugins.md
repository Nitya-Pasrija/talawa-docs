resolvers/Query/getPlugins | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/getPlugins.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/getPlugins.ts#L1)

### Index

### Variables

[getPlugins](../variables/resolvers_Query_getPlugins.getPlugins.html)
