resolvers/Mutation/blockUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Mutation/blockUser.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/blockUser.ts#L1)

### Index

### Variables

[blockUser](../variables/resolvers_Mutation_blockUser.blockUser.html)
