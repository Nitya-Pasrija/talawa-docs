resolvers/Query/eventsByOrganizationConnection | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/eventsByOrganizationConnection.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/eventsByOrganizationConnection.ts#L1)

### Index

### Variables

[eventsByOrganizationConnection](../variables/resolvers_Query_eventsByOrganizationConnection.eventsByOrganizationConnection.html)
