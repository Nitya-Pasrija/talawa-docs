resolvers/Query/event | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/event.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/event.ts#L1)

### Index

### Variables

[event](../variables/resolvers_Query_event.event.html)
