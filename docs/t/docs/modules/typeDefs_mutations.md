typeDefs/mutations | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/typeDefs/mutations.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/mutations.ts#L1)

### Index

### Variables

[mutations](../variables/typeDefs_mutations.mutations.html)
