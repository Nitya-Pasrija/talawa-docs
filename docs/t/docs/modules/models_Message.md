models/Message | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/models/Message.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L1)

### Index

### Interfaces

[InterfaceMessage](../interfaces/models_Message.InterfaceMessage.html)
