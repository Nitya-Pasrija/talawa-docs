config | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/config/index.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/config/index.ts#L1)

##### Index

### References

[androidFirebaseOptions](config.html#androidFirebaseOptions) [appConfig](config.html#appConfig) [iosFirebaseOptions](config.html#iosFirebaseOptions)
...
Re-exports [androidFirebaseOptions](../variables/config_firebaseConfig.androidFirebaseOptions.html)

### appConfig[](#appConfig)

Re-exports [appConfig](../variables/config_appConfig.appConfig.html)

### iosFirebaseOptions[](#iosFirebaseOptions)

Re-exports [iosFirebaseOptions](../variables/config_firebaseConfig.iosFirebaseOptions.html)
...
*   [config](config.html)
    ...
    *   [androidFirebaseOptions](config.html#androidFirebaseOptions)
    *   [appConfig](config.html#appConfig)
    *   [iosFirebaseOptions](config.html#iosFirebaseOptions)
