typeDefs/queries | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/typeDefs/queries.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/queries.ts#L1)

### Index

### Variables

[queries](../variables/typeDefs_queries.queries.html)
