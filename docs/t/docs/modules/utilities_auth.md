utilities/auth | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/utilities/auth.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/auth.ts#L1)

### Index

### Interfaces

[InterfaceJwtTokenPayload](../interfaces/utilities_auth.InterfaceJwtTokenPayload.html)

### Functions

[createAccessToken](../functions/utilities_auth.createAccessToken.html) [createRefreshToken](../functions/utilities_auth.createRefreshToken.html)
