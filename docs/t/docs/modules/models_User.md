models/User | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/models/User.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L1)

### Index

### Interfaces

[InterfaceUser](../interfaces/models_User.InterfaceUser.html)
