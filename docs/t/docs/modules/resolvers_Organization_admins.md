resolvers/Organization/admins | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Organization/admins.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Organization/admins.ts#L1)

### Index

### Variables

[admins](../variables/resolvers_Organization_admins.admins.html)
