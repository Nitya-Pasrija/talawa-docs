libraries | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/libraries/index.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/index.ts#L1)

##### Index

### References

[errors](libraries.html#errors) [logger](libraries.html#logger) [requestContext](libraries.html#requestContext) [requestTracing](libraries.html#requestTracing) [stream](libraries.html#stream)
...
Renames and re-exports [libraries/errors](libraries_errors.html)

### logger[](#logger)

Re-exports [logger](../variables/libraries_logger.logger.html)

### requestContext[](#requestContext)

Renames and re-exports [libraries/requestContext](libraries_requestContext.html)

### requestTracing[](#requestTracing)

Renames and re-exports [libraries/requestTracing](libraries_requestTracing.html)

### stream[](#stream)

Re-exports [stream](../variables/libraries_logger.stream.html)
...
*   [libraries](libraries.html)
    ...
    *   [errors](libraries.html#errors)
    *   [logger](libraries.html#logger)
    *   [requestContext](libraries.html#requestContext)
    *   [requestTracing](libraries.html#requestTracing)
    *   [stream](libraries.html#stream)
