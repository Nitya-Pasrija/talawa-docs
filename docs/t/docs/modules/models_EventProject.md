models/EventProject | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/models/EventProject.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L1)

### Index

### Interfaces

[InterfaceEventProject](../interfaces/models_EventProject.InterfaceEventProject.html)
