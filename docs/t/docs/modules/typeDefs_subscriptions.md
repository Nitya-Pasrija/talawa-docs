typeDefs/subscriptions | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/typeDefs/subscriptions.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/subscriptions.ts#L1)

### Index

### Variables

[subscriptions](../variables/typeDefs_subscriptions.subscriptions.html)
