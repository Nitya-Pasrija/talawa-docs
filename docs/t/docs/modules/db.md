db | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/db.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/db.ts#L1)

### Index

### Functions

[connect](../functions/db.connect.html) [disconnect](../functions/db.disconnect.html)
...
*   [db](db.html)
    ...
    *   [connect](../functions/db.connect.html)
    *   [disconnect](../functions/db.disconnect.html)
