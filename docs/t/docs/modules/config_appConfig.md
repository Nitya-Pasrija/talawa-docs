config/appConfig | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/config/appConfig.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/config/appConfig.ts#L1)

### Index

### Variables

[appConfig](../variables/config_appConfig.appConfig.html)
