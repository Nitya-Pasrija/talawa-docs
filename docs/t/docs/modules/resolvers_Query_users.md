resolvers/Query/users | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/users.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/users.ts#L1)

### Index

### Variables

[users](../variables/resolvers_Query_users.users.html)
