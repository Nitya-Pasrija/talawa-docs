resolvers/User | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/User/index.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/User/index.ts#L1)

### Index

### Variables

[User](../variables/resolvers_User.User.html)
