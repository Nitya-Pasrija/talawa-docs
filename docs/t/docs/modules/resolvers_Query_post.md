resolvers/Query/post | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/post.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/post.ts#L1)

### Index

### Variables

[post](../variables/resolvers_Query_post.post.html)
