resolvers/Query/checkAuth | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/checkAuth.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/checkAuth.ts#L1)

### Index

### Variables

[checkAuth](../variables/resolvers_Query_checkAuth.checkAuth.html)
