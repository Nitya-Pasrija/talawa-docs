models/Organization | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/models/Organization.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Organization.ts#L1)

### Index

### Interfaces

[InterfaceOrganization](../interfaces/models_Organization.InterfaceOrganization.html)
