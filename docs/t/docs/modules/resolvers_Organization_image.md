resolvers/Organization/image | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Organization/image.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Organization/image.ts#L1)

### Index

### Variables

[image](../variables/resolvers_Organization_image.image.html)
