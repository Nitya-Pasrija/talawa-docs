...
*   Defined in [src/resolvers/MembershipRequest/user.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/MembershipRequest/user.ts#L1)
