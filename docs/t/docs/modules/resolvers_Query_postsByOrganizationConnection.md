resolvers/Query/postsByOrganizationConnection | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/resolvers/Query/postsByOrganizationConnection.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/postsByOrganizationConnection.ts#L1)

### Index

### Variables

[postsByOrganizationConnection](../variables/resolvers_Query_postsByOrganizationConnection.postsByOrganizationConnection.html)
