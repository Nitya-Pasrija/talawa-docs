ValidationError | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/libraries/errors/validationError.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/validationError.ts#L6)

##### Index

### Constructors

[constructor](libraries_errors_validationError.ValidationError.html#constructor)

### Properties

[errors](libraries_errors_validationError.ValidationError.html#errors) [httpCode](libraries_errors_validationError.ValidationError.html#httpCode) [message](libraries_errors_validationError.ValidationError.html#message) [name](libraries_errors_validationError.ValidationError.html#name) [stack?](libraries_errors_validationError.ValidationError.html#stack) [prepareStackTrace?](libraries_errors_validationError.ValidationError.html#prepareStackTrace) [stackTraceLimit](libraries_errors_validationError.ValidationError.html#stackTraceLimit)

### Methods

[captureStackTrace](libraries_errors_validationError.ValidationError.html#captureStackTrace)
...
*   new ValidationError(errors?, message?): [ValidationError](libraries_errors_validationError.ValidationError.html)[](#constructor.new_ValidationError)
*   #### Parameters
    ...
    *   ##### message: string = "Validation error"
    ...
    #### Returns [ValidationError](libraries_errors_validationError.ValidationError.html)
    ...
    *   Defined in [src/libraries/errors/validationError.ts:7](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/validationError.ts#L7)
