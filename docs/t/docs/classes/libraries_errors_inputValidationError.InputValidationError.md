InputValidationError | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/libraries/errors/inputValidationError.ts:5](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/inputValidationError.ts#L5)

##### Index

### Constructors

[constructor](libraries_errors_inputValidationError.InputValidationError.html#constructor)

### Properties

[errors](libraries_errors_inputValidationError.InputValidationError.html#errors) [httpCode](libraries_errors_inputValidationError.InputValidationError.html#httpCode) [message](libraries_errors_inputValidationError.InputValidationError.html#message) [name](libraries_errors_inputValidationError.InputValidationError.html#name) [stack?](libraries_errors_inputValidationError.InputValidationError.html#stack) [prepareStackTrace?](libraries_errors_inputValidationError.InputValidationError.html#prepareStackTrace) [stackTraceLimit](libraries_errors_inputValidationError.InputValidationError.html#stackTraceLimit)

### Methods

[captureStackTrace](libraries_errors_inputValidationError.InputValidationError.html#captureStackTrace)
...
*   new InputValidationError(message?, code?, param?, metadata?): [InputValidationError](libraries_errors_inputValidationError.InputValidationError.html)[](#constructor.new_InputValidationError)
*   #### Parameters
    ...
    *   ##### metadata: Record<any, any\> = {}
    ...
    #### Returns [InputValidationError](libraries_errors_inputValidationError.InputValidationError.html)
    ...
    *   Defined in [src/libraries/errors/inputValidationError.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/inputValidationError.ts#L6)
