NotFoundError | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/libraries/errors/notFoundError.ts:5](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/notFoundError.ts#L5)

##### Index

### Constructors

[constructor](libraries_errors_notFoundError.NotFoundError.html#constructor)

### Properties

[errors](libraries_errors_notFoundError.NotFoundError.html#errors) [httpCode](libraries_errors_notFoundError.NotFoundError.html#httpCode) [message](libraries_errors_notFoundError.NotFoundError.html#message) [name](libraries_errors_notFoundError.NotFoundError.html#name) [stack?](libraries_errors_notFoundError.NotFoundError.html#stack) [prepareStackTrace?](libraries_errors_notFoundError.NotFoundError.html#prepareStackTrace) [stackTraceLimit](libraries_errors_notFoundError.NotFoundError.html#stackTraceLimit)

### Methods

[captureStackTrace](libraries_errors_notFoundError.NotFoundError.html#captureStackTrace)
...
*   new NotFoundError(message?, code?, param?, metadata?): [NotFoundError](libraries_errors_notFoundError.NotFoundError.html)[](#constructor.new_NotFoundError)
*   #### Parameters
    ...
    *   ##### metadata: Record<any, any\> = {}
    ...
    #### Returns [NotFoundError](libraries_errors_notFoundError.NotFoundError.html)
    ...
    *   Defined in [src/libraries/errors/notFoundError.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/notFoundError.ts#L6)
