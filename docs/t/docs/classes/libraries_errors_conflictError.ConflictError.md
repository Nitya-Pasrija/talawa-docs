ConflictError | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/libraries/errors/conflictError.ts:5](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/conflictError.ts#L5)

##### Index

### Constructors

[constructor](libraries_errors_conflictError.ConflictError.html#constructor)

### Properties

[errors](libraries_errors_conflictError.ConflictError.html#errors) [httpCode](libraries_errors_conflictError.ConflictError.html#httpCode) [message](libraries_errors_conflictError.ConflictError.html#message) [name](libraries_errors_conflictError.ConflictError.html#name) [stack?](libraries_errors_conflictError.ConflictError.html#stack) [prepareStackTrace?](libraries_errors_conflictError.ConflictError.html#prepareStackTrace) [stackTraceLimit](libraries_errors_conflictError.ConflictError.html#stackTraceLimit)

### Methods

[captureStackTrace](libraries_errors_conflictError.ConflictError.html#captureStackTrace)
...
*   new ConflictError(message?, code?, param?, metadata?): [ConflictError](libraries_errors_conflictError.ConflictError.html)[](#constructor.new_ConflictError)
*   #### Parameters
    ...
    *   ##### metadata: Record<any, any\> = {}
    ...
    #### Returns [ConflictError](libraries_errors_conflictError.ConflictError.html)
    ...
    *   Defined in [src/libraries/errors/conflictError.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/conflictError.ts#L6)
