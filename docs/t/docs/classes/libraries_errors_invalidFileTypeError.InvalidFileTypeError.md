InvalidFileTypeError | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/libraries/errors/invalidFileTypeError.ts:5](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/invalidFileTypeError.ts#L5)

##### Index

### Constructors

[constructor](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html#constructor)

### Properties

[errors](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html#errors) [httpCode](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html#httpCode) [message](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html#message) [name](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html#name) [stack?](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html#stack) [prepareStackTrace?](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html#prepareStackTrace) [stackTraceLimit](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html#stackTraceLimit)

### Methods

[captureStackTrace](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html#captureStackTrace)
...
*   new InvalidFileTypeError(message?, code?, param?, metadata?): [InvalidFileTypeError](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html)[](#constructor.new_InvalidFileTypeError)
*   #### Parameters
    ...
    *   ##### metadata: Record<any, any\> = {}
    ...
    #### Returns [InvalidFileTypeError](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html)
    ...
    *   Defined in [src/libraries/errors/invalidFileTypeError.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/invalidFileTypeError.ts#L6)
