ApplicationError | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Error
    *   ApplicationError
        *   [ConflictError](libraries_errors_conflictError.ConflictError.html)
        *   [InputValidationError](libraries_errors_inputValidationError.InputValidationError.html)
        *   [InternalServerError](libraries_errors_internalServerError.InternalServerError.html)
        *   [InvalidFileTypeError](libraries_errors_invalidFileTypeError.InvalidFileTypeError.html)
        *   [NotFoundError](libraries_errors_notFoundError.NotFoundError.html)
        *   [UnauthenticatedError](libraries_errors_unauthenticatedError.UnauthenticatedError.html)
...
*   Defined in [src/libraries/errors/applicationError.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/applicationError.ts#L10)

##### Index

### Constructors

[constructor](libraries_errors_applicationError.ApplicationError.html#constructor)

### Properties

[errors](libraries_errors_applicationError.ApplicationError.html#errors) [httpCode](libraries_errors_applicationError.ApplicationError.html#httpCode) [message](libraries_errors_applicationError.ApplicationError.html#message) [name](libraries_errors_applicationError.ApplicationError.html#name) [stack?](libraries_errors_applicationError.ApplicationError.html#stack) [prepareStackTrace?](libraries_errors_applicationError.ApplicationError.html#prepareStackTrace) [stackTraceLimit](libraries_errors_applicationError.ApplicationError.html#stackTraceLimit)

### Methods

[captureStackTrace](libraries_errors_applicationError.ApplicationError.html#captureStackTrace)
...
*   new ApplicationError(errors, httpCode?, message?): [ApplicationError](libraries_errors_applicationError.ApplicationError.html)[](#constructor.new_ApplicationError)
*   #### Parameters
    ...
    *   ##### message: string = "Error"
    ...
    #### Returns [ApplicationError](libraries_errors_applicationError.ApplicationError.html)
    
    Overrides Error.constructor
    
    *   Defined in [src/libraries/errors/applicationError.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/applicationError.ts#L14)
...
*   Defined in [src/libraries/errors/applicationError.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/applicationError.ts#L11)

### httpCode[](#httpCode)

httpCode: number

*   Defined in [src/libraries/errors/applicationError.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/applicationError.ts#L12)
...
*   [libraries/errors/applicationError](../modules/libraries_errors_applicationError.html)
    ...
    *   [ApplicationError](libraries_errors_applicationError.ApplicationError.html)
    *   [InterfaceError](../interfaces/libraries_errors_applicationError.InterfaceError.html)
