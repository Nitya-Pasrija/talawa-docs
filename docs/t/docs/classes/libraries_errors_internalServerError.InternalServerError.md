InternalServerError | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/libraries/errors/internalServerError.ts:5](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/internalServerError.ts#L5)

##### Index

### Constructors

[constructor](libraries_errors_internalServerError.InternalServerError.html#constructor)

### Properties

[errors](libraries_errors_internalServerError.InternalServerError.html#errors) [httpCode](libraries_errors_internalServerError.InternalServerError.html#httpCode) [message](libraries_errors_internalServerError.InternalServerError.html#message) [name](libraries_errors_internalServerError.InternalServerError.html#name) [stack?](libraries_errors_internalServerError.InternalServerError.html#stack) [prepareStackTrace?](libraries_errors_internalServerError.InternalServerError.html#prepareStackTrace) [stackTraceLimit](libraries_errors_internalServerError.InternalServerError.html#stackTraceLimit)

### Methods

[captureStackTrace](libraries_errors_internalServerError.InternalServerError.html#captureStackTrace)
...
*   new InternalServerError(message?, code?, param?, metadata?): [InternalServerError](libraries_errors_internalServerError.InternalServerError.html)[](#constructor.new_InternalServerError)
*   #### Parameters
    ...
    *   ##### metadata: Record<any, any\> = {}
    ...
    #### Returns [InternalServerError](libraries_errors_internalServerError.InternalServerError.html)
    ...
    *   Defined in [src/libraries/errors/internalServerError.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/internalServerError.ts#L6)
