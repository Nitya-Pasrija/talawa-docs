UnauthenticatedError | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/libraries/errors/unauthenticatedError.ts:5](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/unauthenticatedError.ts#L5)

##### Index

### Constructors

[constructor](libraries_errors_unauthenticatedError.UnauthenticatedError.html#constructor)

### Properties

[errors](libraries_errors_unauthenticatedError.UnauthenticatedError.html#errors) [httpCode](libraries_errors_unauthenticatedError.UnauthenticatedError.html#httpCode) [message](libraries_errors_unauthenticatedError.UnauthenticatedError.html#message) [name](libraries_errors_unauthenticatedError.UnauthenticatedError.html#name) [stack?](libraries_errors_unauthenticatedError.UnauthenticatedError.html#stack) [prepareStackTrace?](libraries_errors_unauthenticatedError.UnauthenticatedError.html#prepareStackTrace) [stackTraceLimit](libraries_errors_unauthenticatedError.UnauthenticatedError.html#stackTraceLimit)

### Methods

[captureStackTrace](libraries_errors_unauthenticatedError.UnauthenticatedError.html#captureStackTrace)
...
*   new UnauthenticatedError(message?, code?, param?, metadata?): [UnauthenticatedError](libraries_errors_unauthenticatedError.UnauthenticatedError.html)[](#constructor.new_UnauthenticatedError)
*   #### Parameters
    ...
    *   ##### metadata: Record<any, any\> = {}
    ...
    #### Returns [UnauthenticatedError](libraries_errors_unauthenticatedError.UnauthenticatedError.html)
    ...
    *   Defined in [src/libraries/errors/unauthenticatedError.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/unauthenticatedError.ts#L6)
