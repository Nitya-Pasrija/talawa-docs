Comment | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    post: [Post](types_generatedGraphQLTypes.Post.html);  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:74](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L74)
