PageInfo | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    currPageNo?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>;  
    hasNextPage: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
    hasPreviousPage: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
    nextPageNo?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>;  
    prevPageNo?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>;  
    totalPages?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>;  
}
...
*   ##### `Optional` currPageNo?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>
...
*   ##### `Optional` nextPageNo?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>
    
*   ##### `Optional` prevPageNo?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>
    
*   ##### `Optional` totalPages?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>
    

*   Defined in [src/types/generatedGraphQLTypes.ts:948](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L948)
