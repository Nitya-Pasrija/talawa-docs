MutationUpdateUserTagArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    input: [UpdateUserTagInput](types_generatedGraphQLTypes.UpdateUserTagInput.html);  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:834](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L834)
