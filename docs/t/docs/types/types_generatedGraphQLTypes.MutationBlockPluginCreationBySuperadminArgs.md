MutationBlockPluginCreationBySuperadminArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    blockUser: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:495](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L495)
