MutationUpdateEventArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[UpdateEventInput](types_generatedGraphQLTypes.UpdateEventInput.html)\>;  
    id: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
}

#### Type declaration

*   ##### `Optional` data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[UpdateEventInput](types_generatedGraphQLTypes.UpdateEventInput.html)\>
    
*   ##### id: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]
    

*   Defined in [src/types/generatedGraphQLTypes.ts:781](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L781)
