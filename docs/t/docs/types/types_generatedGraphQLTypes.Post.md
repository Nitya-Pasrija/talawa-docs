Post | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Post: {  
    \_\_typename?: "Post";  
    \_id?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]\>;  
    commentCount?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>;  
    comments?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[Comment](types_generatedGraphQLTypes.Comment.html)\>\[\]\>;  
...
    imageUrl?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["URL"\]\>;  
    likeCount?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>;  
    likedBy?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[User](types_generatedGraphQLTypes.User.html)\>\[\]\>;  
    organization: [Organization](types_generatedGraphQLTypes.Organization.html);  
    text: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    title?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>;  
    videoUrl?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["URL"\]\>;  
}
...
*   ##### `Optional` \_id?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]\>
    
*   ##### `Optional` commentCount?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>
    
*   ##### `Optional` comments?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[Comment](types_generatedGraphQLTypes.Comment.html)\>\[\]\>
...
*   ##### `Optional` imageUrl?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["URL"\]\>
    
*   ##### `Optional` likeCount?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>
    
*   ##### `Optional` likedBy?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Maybe](types_generatedGraphQLTypes.Maybe.html)<[User](types_generatedGraphQLTypes.User.html)\>\[\]\>
    
*   ##### organization: [Organization](types_generatedGraphQLTypes.Organization.html)
    
*   ##### text: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]
    
*   ##### `Optional` title?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>
    
*   ##### `Optional` videoUrl?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["URL"\]\>
    

*   Defined in [src/types/generatedGraphQLTypes.ts:991](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L991)
