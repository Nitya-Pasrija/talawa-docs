UserEdge | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
UserEdge: {  
    \_\_typename?: "UserEdge";  
    cursor: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    node: [User](types_generatedGraphQLTypes.User.html);  
}

#### Type declaration

*   ##### `Optional` \_\_typename?: "UserEdge"
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1447](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1447)
