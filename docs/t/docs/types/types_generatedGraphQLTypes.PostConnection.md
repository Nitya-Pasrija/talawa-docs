PostConnection | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
PostConnection: {  
    \_\_typename?: "PostConnection";  
    aggregate: [AggregatePost](types_generatedGraphQLTypes.AggregatePost.html);  
    edges: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Post](types_generatedGraphQLTypes.Post.html)\>\[\];  
...
*   ##### `Optional` \_\_typename?: "PostConnection"
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1008](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1008)
