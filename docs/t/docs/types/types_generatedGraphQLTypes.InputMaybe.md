InputMaybe | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
InputMaybe<T\>: [Maybe](types_generatedGraphQLTypes.Maybe.html)<T\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L22)
