DirectiveResolverFn | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   *   (next, parent, args, context, info?): TResult | Promise<TResult\>
    *   #### Parameters
        ...
        *   ##### next: [NextResolverFn](types_generatedGraphQLTypes.NextResolverFn.html)<TResult\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1624](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1624)
