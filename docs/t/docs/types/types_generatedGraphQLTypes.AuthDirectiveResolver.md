AuthDirectiveResolver | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
AuthDirectiveResolver<Result, Parent, ContextType, Args\>: [DirectiveResolverFn](types_generatedGraphQLTypes.DirectiveResolverFn.html)<Result, Parent, ContextType, Args\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1829](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1829)
