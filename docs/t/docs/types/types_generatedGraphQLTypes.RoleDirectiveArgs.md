RoleDirectiveArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
RoleDirectiveArgs: {  
    requires?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserType](types_generatedGraphQLTypes.UserType.html)\>;  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1831](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1831)
