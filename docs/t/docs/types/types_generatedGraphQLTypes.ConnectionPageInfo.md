ConnectionPageInfo | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
ConnectionPageInfo: {  
    \_\_typename?: "ConnectionPageInfo";  
    endCursor?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>;  
...
    startCursor?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>;  
}

#### Type declaration

*   ##### `Optional` \_\_typename?: "ConnectionPageInfo"
    
*   ##### `Optional` endCursor?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>
    
*   ##### hasNextPage: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\]
    
*   ##### hasPreviousPage: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\]
    
*   ##### `Optional` startCursor?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>
    

*   Defined in [src/types/generatedGraphQLTypes.ts:89](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L89)
