RequireFields | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
RequireFields<T, K\>: [Omit](types_generatedGraphQLTypes.Omit.html)<T, K\> & {  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:27](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L27)
