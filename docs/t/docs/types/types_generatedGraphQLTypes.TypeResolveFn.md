TypeResolveFn | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
TypeResolveFn<TTypes, TParent, TContext\>: ((parent, context, info?) => [Maybe](types_generatedGraphQLTypes.Maybe.html)<TTypes\> | Promise<[Maybe](types_generatedGraphQLTypes.Maybe.html)<TTypes\>\>)
...
*   *   (parent, context, info?): [Maybe](types_generatedGraphQLTypes.Maybe.html)<TTypes\> | Promise<[Maybe](types_generatedGraphQLTypes.Maybe.html)<TTypes\>\>
    *   #### Parameters
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1614](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1614)
