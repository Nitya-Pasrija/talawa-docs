QueryTasksByEventArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Type alias QueryTasksByEventArgs
================================

QueryTasksByEventArgs: {  
    id: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
    orderBy?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[TaskOrderByInput](types_generatedGraphQLTypes.TaskOrderByInput.html)\>;  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1235](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1235)
