MutationCreatePostArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    data: [PostInput](types_generatedGraphQLTypes.PostInput.html);  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:573](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L573)
