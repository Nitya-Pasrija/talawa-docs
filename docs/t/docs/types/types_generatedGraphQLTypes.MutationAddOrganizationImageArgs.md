MutationAddOrganizationImageArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    file: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:463](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L463)
