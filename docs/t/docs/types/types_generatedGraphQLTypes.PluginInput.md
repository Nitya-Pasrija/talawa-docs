PluginInput | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
PluginInput: {  
    fields?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[PluginFieldInput](types_generatedGraphQLTypes.PluginFieldInput.html)\>\[\]\>;  
    orgId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
    pluginKey?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>;  
    pluginName: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    pluginType?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Type](types_generatedGraphQLTypes.Type.html)\>;  
}

#### Type declaration

*   ##### `Optional` fields?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[PluginFieldInput](types_generatedGraphQLTypes.PluginFieldInput.html)\>\[\]\>
    
*   ##### orgId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]
    
*   ##### `Optional` pluginKey?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\]\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:983](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L983)
