QueryOrganizationsMemberConnectionArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    orderBy?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[UserOrderByInput](types_generatedGraphQLTypes.UserOrderByInput.html)\>;  
...
    where?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[UserWhereInput](types_generatedGraphQLTypes.UserWhereInput.html)\>;  
}
...
*   ##### `Optional` orderBy?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[UserOrderByInput](types_generatedGraphQLTypes.UserOrderByInput.html)\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1190](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1190)
