MessageChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    languageBarrier?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\]\>;  
    message: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    receiver: [User](types_generatedGraphQLTypes.User.html);  
...
*   ##### `Optional` languageBarrier?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\]\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:353](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L353)
