UpdateUserPasswordInput | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    confirmNewPassword: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    newPassword: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1376](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1376)
