Mutation | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Mutation: {  
    \_\_typename?: "Mutation";  
    acceptAdmin: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
    acceptMembershipRequest: [MembershipRequest](types_generatedGraphQLTypes.MembershipRequest.html);  
    addLanguageTranslation: [Language](types_generatedGraphQLTypes.Language.html);  
    addOrganizationImage: [Organization](types_generatedGraphQLTypes.Organization.html);  
    addUserImage: [User](types_generatedGraphQLTypes.User.html);  
    addUserToGroupChat: [GroupChat](types_generatedGraphQLTypes.GroupChat.html);  
    adminRemoveEvent: [Event](types_generatedGraphQLTypes.Event.html);  
    adminRemoveGroup: [GroupChat](types_generatedGraphQLTypes.GroupChat.html);  
    assignUserTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[User](types_generatedGraphQLTypes.User.html)\>;  
    blockPluginCreationBySuperadmin: [User](types_generatedGraphQLTypes.User.html);  
    blockUser: [User](types_generatedGraphQLTypes.User.html);  
    cancelMembershipRequest: [MembershipRequest](types_generatedGraphQLTypes.MembershipRequest.html);  
    createAdmin: [User](types_generatedGraphQLTypes.User.html);  
    createComment?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Comment](types_generatedGraphQLTypes.Comment.html)\>;  
    createDirectChat: [DirectChat](types_generatedGraphQLTypes.DirectChat.html);  
    createDonation: [Donation](types_generatedGraphQLTypes.Donation.html);  
    createEvent: [Event](types_generatedGraphQLTypes.Event.html);  
    createGroupChat: [GroupChat](types_generatedGraphQLTypes.GroupChat.html);  
    createMember: [Organization](types_generatedGraphQLTypes.Organization.html);  
    createMessageChat: [MessageChat](types_generatedGraphQLTypes.MessageChat.html);  
    createOrganization: [Organization](types_generatedGraphQLTypes.Organization.html);  
    createPlugin: [Plugin](types_generatedGraphQLTypes.Plugin.html);  
    createPost?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Post](types_generatedGraphQLTypes.Post.html)\>;  
    createTask: [Task](types_generatedGraphQLTypes.Task.html);  
    createUserTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTag](types_generatedGraphQLTypes.UserTag.html)\>;  
    deleteDonationById: [DeletePayload](types_generatedGraphQLTypes.DeletePayload.html);  
    forgotPassword: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
    joinPublicOrganization: [User](types_generatedGraphQLTypes.User.html);  
    leaveOrganization: [User](types_generatedGraphQLTypes.User.html);  
    likeComment?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Comment](types_generatedGraphQLTypes.Comment.html)\>;  
    likePost?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Post](types_generatedGraphQLTypes.Post.html)\>;  
    login: [AuthData](types_generatedGraphQLTypes.AuthData.html);  
    logout: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
    otp: [OtpData](types_generatedGraphQLTypes.OtpData.html);  
    recaptcha: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
    refreshToken: [ExtendSession](types_generatedGraphQLTypes.ExtendSession.html);  
    registerForEvent: [Event](types_generatedGraphQLTypes.Event.html);  
    rejectAdmin: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
    rejectMembershipRequest: [MembershipRequest](types_generatedGraphQLTypes.MembershipRequest.html);  
    removeAdmin: [User](types_generatedGraphQLTypes.User.html);  
    removeComment?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Comment](types_generatedGraphQLTypes.Comment.html)\>;  
    removeDirectChat: [DirectChat](types_generatedGraphQLTypes.DirectChat.html);  
    removeEvent: [Event](types_generatedGraphQLTypes.Event.html);  
    removeGroupChat: [GroupChat](types_generatedGraphQLTypes.GroupChat.html);  
    removeMember: [Organization](types_generatedGraphQLTypes.Organization.html);  
    removeOrganization: [User](types_generatedGraphQLTypes.User.html);  
    removeOrganizationImage: [Organization](types_generatedGraphQLTypes.Organization.html);  
    removePost?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Post](types_generatedGraphQLTypes.Post.html)\>;  
    removeTask?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Task](types_generatedGraphQLTypes.Task.html)\>;  
    removeUserFromGroupChat: [GroupChat](types_generatedGraphQLTypes.GroupChat.html);  
    removeUserImage: [User](types_generatedGraphQLTypes.User.html);  
    removeUserTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTag](types_generatedGraphQLTypes.UserTag.html)\>;  
    revokeRefreshTokenForUser: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
    saveFcmToken: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
    sendMembershipRequest: [MembershipRequest](types_generatedGraphQLTypes.MembershipRequest.html);  
    sendMessageToDirectChat: [DirectChatMessage](types_generatedGraphQLTypes.DirectChatMessage.html);  
    sendMessageToGroupChat: [GroupChatMessage](types_generatedGraphQLTypes.GroupChatMessage.html);  
    signUp: [AuthData](types_generatedGraphQLTypes.AuthData.html);  
    togglePostPin: [Post](types_generatedGraphQLTypes.Post.html);  
    unassignUserTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[User](types_generatedGraphQLTypes.User.html)\>;  
    unblockUser: [User](types_generatedGraphQLTypes.User.html);  
    unlikeComment?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Comment](types_generatedGraphQLTypes.Comment.html)\>;  
    unlikePost?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Post](types_generatedGraphQLTypes.Post.html)\>;  
    unregisterForEventByUser: [Event](types_generatedGraphQLTypes.Event.html);  
    updateEvent: [Event](types_generatedGraphQLTypes.Event.html);  
    updateLanguage: [User](types_generatedGraphQLTypes.User.html);  
    updateOrganization: [Organization](types_generatedGraphQLTypes.Organization.html);  
    updatePluginInstalledOrgs: [Plugin](types_generatedGraphQLTypes.Plugin.html);  
    updatePluginStatus: [Plugin](types_generatedGraphQLTypes.Plugin.html);  
    updatePost: [Post](types_generatedGraphQLTypes.Post.html);  
    updateTask?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Task](types_generatedGraphQLTypes.Task.html)\>;  
    updateUserPassword: [User](types_generatedGraphQLTypes.User.html);  
    updateUserProfile: [User](types_generatedGraphQLTypes.User.html);  
    updateUserTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTag](types_generatedGraphQLTypes.UserTag.html)\>;  
...
*   ##### `Optional` assignUserTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[User](types_generatedGraphQLTypes.User.html)\>
...
*   ##### `Optional` createComment?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Comment](types_generatedGraphQLTypes.Comment.html)\>
...
*   ##### `Optional` createPost?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Post](types_generatedGraphQLTypes.Post.html)\>
    
*   ##### createTask: [Task](types_generatedGraphQLTypes.Task.html)
    
*   ##### `Optional` createUserTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTag](types_generatedGraphQLTypes.UserTag.html)\>
...
*   ##### `Optional` likeComment?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Comment](types_generatedGraphQLTypes.Comment.html)\>
    
*   ##### `Optional` likePost?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Post](types_generatedGraphQLTypes.Post.html)\>
...
*   ##### `Optional` removeComment?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Comment](types_generatedGraphQLTypes.Comment.html)\>
...
*   ##### `Optional` removePost?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Post](types_generatedGraphQLTypes.Post.html)\>
    
*   ##### `Optional` removeTask?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Task](types_generatedGraphQLTypes.Task.html)\>
    
*   ##### removeUserFromGroupChat: [GroupChat](types_generatedGraphQLTypes.GroupChat.html)
    
*   ##### removeUserImage: [User](types_generatedGraphQLTypes.User.html)
    
*   ##### `Optional` removeUserTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTag](types_generatedGraphQLTypes.UserTag.html)\>
...
*   ##### `Optional` unassignUserTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[User](types_generatedGraphQLTypes.User.html)\>
    
*   ##### unblockUser: [User](types_generatedGraphQLTypes.User.html)
    
*   ##### `Optional` unlikeComment?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Comment](types_generatedGraphQLTypes.Comment.html)\>
    
*   ##### `Optional` unlikePost?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Post](types_generatedGraphQLTypes.Post.html)\>
...
*   ##### `Optional` updateTask?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[Task](types_generatedGraphQLTypes.Task.html)\>
    
*   ##### updateUserPassword: [User](types_generatedGraphQLTypes.User.html)
    
*   ##### updateUserProfile: [User](types_generatedGraphQLTypes.User.html)
    
*   ##### `Optional` updateUserTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTag](types_generatedGraphQLTypes.UserTag.html)\>
    
*   ##### updateUserType: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\]
    

*   Defined in [src/types/generatedGraphQLTypes.ts:368](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L368)
