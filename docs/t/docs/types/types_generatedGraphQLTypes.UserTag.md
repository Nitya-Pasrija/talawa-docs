UserTag | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    childTags?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTagsConnection](types_generatedGraphQLTypes.UserTagsConnection.html)\>;  
...
    parentTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTag](types_generatedGraphQLTypes.UserTag.html)\>;  
    usersAssignedTo?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UsersConnection](types_generatedGraphQLTypes.UsersConnection.html)\>;  
}
...
*   ##### `Optional` childTags?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTagsConnection](types_generatedGraphQLTypes.UserTagsConnection.html)\>
...
*   ##### `Optional` parentTag?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<[UserTag](types_generatedGraphQLTypes.UserTag.html)\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1474](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1474)
