OtpDataResolvers | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
OtpDataResolvers<ContextType, ParentType\>: {  
    \_\_isTypeOf?: [IsTypeOfResolverFn](types_generatedGraphQLTypes.IsTypeOfResolverFn.html)<ParentType, ContextType\>;  
    otpToken?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\], ParentType, ContextType\>;  
}
...
*   #### ParentType extends [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["OtpData"\] = [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["OtpData"\]
...
*   ##### `Optional` otpToken?: [Resolver](types_generatedGraphQLTypes.Resolver.html)<[ResolversTypes](types_generatedGraphQLTypes.ResolversTypes.html)\["String"\], ParentType, ContextType\>
    

*   Defined in [src/types/generatedGraphQLTypes.ts:2169](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L2169)
