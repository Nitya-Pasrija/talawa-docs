MutationCreateTaskArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Type alias MutationCreateTaskArgs
=================================

MutationCreateTaskArgs: {  
    data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[TaskInput](types_generatedGraphQLTypes.TaskInput.html)\>;  
    eventId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\];  
}

#### Type declaration

*   ##### `Optional` data?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[TaskInput](types_generatedGraphQLTypes.TaskInput.html)\>
    
*   ##### eventId: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]
    

*   Defined in [src/types/generatedGraphQLTypes.ts:579](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L579)
