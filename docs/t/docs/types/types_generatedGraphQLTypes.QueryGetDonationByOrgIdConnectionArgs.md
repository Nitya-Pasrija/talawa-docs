QueryGetDonationByOrgIdConnectionArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    where?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[DonationWhereInput](types_generatedGraphQLTypes.DonationWhereInput.html)\>;  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1153](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1153)
