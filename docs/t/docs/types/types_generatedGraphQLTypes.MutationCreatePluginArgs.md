MutationCreatePluginArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    installedOrgs?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]\[\]\>;  
    pluginCreatedBy: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    pluginDesc: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
    pluginInstallStatus: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["Boolean"\];  
    pluginName: [Scalars](types_generatedGraphQLTypes.Scalars.html)\["String"\];  
}

#### Type declaration

*   ##### `Optional` installedOrgs?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["ID"\]\[\]\>
...
*   Defined in [src/types/generatedGraphQLTypes.ts:564](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L564)
