MakeOptional | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
MakeOptional<T, K\>: [Omit](types_generatedGraphQLTypes.Omit.html)<T, K\> & {  
    \[SubKey in K\]?: [Maybe](types_generatedGraphQLTypes.Maybe.html)<T\[SubKey\]\>  
}
...
*   Defined in [src/types/generatedGraphQLTypes.ts:24](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L24)
