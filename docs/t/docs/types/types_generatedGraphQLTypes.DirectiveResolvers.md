DirectiveResolvers | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    auth?: [AuthDirectiveResolver](types_generatedGraphQLTypes.AuthDirectiveResolver.html)<any, any, ContextType\>;  
    role?: [RoleDirectiveResolver](types_generatedGraphQLTypes.RoleDirectiveResolver.html)<any, any, ContextType\>;  
}
...
*   ##### `Optional` auth?: [AuthDirectiveResolver](types_generatedGraphQLTypes.AuthDirectiveResolver.html)<any, any, ContextType\>
    
*   ##### `Optional` role?: [RoleDirectiveResolver](types_generatedGraphQLTypes.RoleDirectiveResolver.html)<any, any, ContextType\>
    

*   Defined in [src/types/generatedGraphQLTypes.ts:2430](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L2430)
