QueryOrganizationsConnectionArgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
    first?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>;  
    orderBy?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[OrganizationOrderByInput](types_generatedGraphQLTypes.OrganizationOrderByInput.html)\>;  
    skip?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>;  
    where?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[OrganizationWhereInput](types_generatedGraphQLTypes.OrganizationWhereInput.html)\>;  
}

#### Type declaration

*   ##### `Optional` first?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>
    
*   ##### `Optional` orderBy?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[OrganizationOrderByInput](types_generatedGraphQLTypes.OrganizationOrderByInput.html)\>
    
*   ##### `Optional` skip?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[Scalars](types_generatedGraphQLTypes.Scalars.html)\["Int"\]\>
    
*   ##### `Optional` where?: [InputMaybe](types_generatedGraphQLTypes.InputMaybe.html)<[OrganizationWhereInput](types_generatedGraphQLTypes.OrganizationWhereInput.html)\>
    

*   Defined in [src/types/generatedGraphQLTypes.ts:1182](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1182)
