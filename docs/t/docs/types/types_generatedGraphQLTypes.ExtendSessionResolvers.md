ExtendSessionResolvers | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
ExtendSessionResolvers<ContextType, ParentType\>: {  
...
*   #### ParentType extends [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["ExtendSession"\] = [ResolversParentTypes](types_generatedGraphQLTypes.ResolversParentTypes.html)\["ExtendSession"\]
...
*   Defined in [src/types/generatedGraphQLTypes.ts:1962](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/types/generatedGraphQLTypes.ts#L1962)
