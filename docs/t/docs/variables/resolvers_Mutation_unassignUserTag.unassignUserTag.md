unassignUserTag | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [unassignUserTag](resolvers_Mutation_unassignUserTag.unassignUserTag.html)

Variable unassignUserTag`Const`
===============================

unassignUserTag: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["unassignUserTag"\] = ...

*   Defined in [src/resolvers/Mutation/unassignUserTag.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/unassignUserTag.ts#L11)
