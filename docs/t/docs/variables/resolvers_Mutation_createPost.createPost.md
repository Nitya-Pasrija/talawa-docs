createPost | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createPost](resolvers_Mutation_createPost.createPost.html)

Variable createPost`Const`
==========================

createPost: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createPost"\] = ...
...
*   Defined in [src/resolvers/Mutation/createPost.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/createPost.ts#L22)
