ERROR\_IN\_SENDING\_MAIL | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable ERROR\_IN\_SENDING\_MAIL`Const`
========================================

ERROR\_IN\_SENDING\_MAIL: "Error in sending mail" = "Error in sending mail"

*   Defined in [src/constants.ts:21](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L21)
