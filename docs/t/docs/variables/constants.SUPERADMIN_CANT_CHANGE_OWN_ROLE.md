SUPERADMIN\_CANT\_CHANGE\_OWN\_ROLE | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable SUPERADMIN\_CANT\_CHANGE\_OWN\_ROLE`Const`
===================================================
...
*   Defined in [src/constants.ts:274](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L274)
