forgotPassword | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [forgotPassword](resolvers_Mutation_forgotPassword.forgotPassword.html)

Variable forgotPassword`Const`
==============================

forgotPassword: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["forgotPassword"\] = ...
...
*   Defined in [src/resolvers/Mutation/forgotPassword.ts:17](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/forgotPassword.ts#L17)
