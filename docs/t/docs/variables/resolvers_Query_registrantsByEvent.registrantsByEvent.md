registrantsByEvent | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [registrantsByEvent](resolvers_Query_registrantsByEvent.registrantsByEvent.html)

Variable registrantsByEvent`Const`
==================================

registrantsByEvent: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["registrantsByEvent"\] = ...
...
*   Defined in [src/resolvers/Query/registrantsByEvent.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/registrantsByEvent.ts#L13)
