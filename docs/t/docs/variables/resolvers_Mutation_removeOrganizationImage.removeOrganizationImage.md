removeOrganizationImage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeOrganizationImage](resolvers_Mutation_removeOrganizationImage.removeOrganizationImage.html)

Variable removeOrganizationImage`Const`
=======================================

removeOrganizationImage: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeOrganizationImage"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeOrganizationImage.ts:21](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeOrganizationImage.ts#L21)
