interfaces | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [interfaces](typeDefs_interfaces.interfaces.html)

Variable interfaces`Const`
==========================

interfaces: DocumentNode = ...

*   Defined in [src/typeDefs/interfaces.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/interfaces.ts#L4)
