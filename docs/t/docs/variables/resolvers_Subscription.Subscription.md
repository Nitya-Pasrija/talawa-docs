...
*   [Subscription](resolvers_Subscription.Subscription.html)

Variable Subscription`Const`
============================

Subscription: [SubscriptionResolvers](../types/types_generatedGraphQLTypes.SubscriptionResolvers.html) = ...

*   Defined in [src/resolvers/Subscription/index.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Subscription/index.ts#L6)
