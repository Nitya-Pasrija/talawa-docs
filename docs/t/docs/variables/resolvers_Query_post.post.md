...
*   [post](resolvers_Query_post.post.html)

Variable post`Const`
====================

post: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["post"\] = ...
...
*   Defined in [src/resolvers/Query/post.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/post.ts#L11)
