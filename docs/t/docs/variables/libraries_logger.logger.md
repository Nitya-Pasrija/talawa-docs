logger | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable logger`Const`
======================

logger: Logger = ...

*   Defined in [src/libraries/logger.ts:42](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/logger.ts#L42)
