updateUserType | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [updateUserType](resolvers_Mutation_updateUserType.updateUserType.html)

Variable updateUserType`Const`
==============================

updateUserType: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["updateUserType"\] = ...
...
*   Defined in [src/resolvers/Mutation/updateUserType.ts:18](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/updateUserType.ts#L18)
