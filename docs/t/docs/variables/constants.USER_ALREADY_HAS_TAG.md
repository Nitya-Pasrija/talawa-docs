USER\_ALREADY\_HAS\_TAG | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable USER\_ALREADY\_HAS\_TAG`Const`
=======================================
...
*   Defined in [src/constants.ts:222](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L222)
