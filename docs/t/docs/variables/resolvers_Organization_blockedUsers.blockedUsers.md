blockedUsers | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [blockedUsers](resolvers_Organization_blockedUsers.blockedUsers.html)

Variable blockedUsers`Const`
============================

blockedUsers: [OrganizationResolvers](../types/types_generatedGraphQLTypes.OrganizationResolvers.html)\["blockedUsers"\] = ...
...
*   Defined in [src/resolvers/Organization/blockedUsers.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Organization/blockedUsers.ts#L8)
