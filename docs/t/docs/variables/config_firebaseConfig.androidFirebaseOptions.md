...
*   [androidFirebaseOptions](config_firebaseConfig.androidFirebaseOptions.html)

Variable androidFirebaseOptions`Const`
======================================
...
*   Defined in [src/config/firebaseConfig.ts:16](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/config/firebaseConfig.ts#L16)
...
*   [config/firebaseConfig](../modules/config_firebaseConfig.html)
    ...
    *   [androidFirebaseOptions](config_firebaseConfig.androidFirebaseOptions.html)
    *   [iosFirebaseOptions](config_firebaseConfig.iosFirebaseOptions.html)
