USER\_NOT\_AUTHORIZED\_ADMIN | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable USER\_NOT\_AUTHORIZED\_ADMIN`Const`
============================================
...
*   Defined in [src/constants.ts:131](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L131)
