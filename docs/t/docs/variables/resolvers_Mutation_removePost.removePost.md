removePost | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removePost](resolvers_Mutation_removePost.removePost.html)

Variable removePost`Const`
==========================

removePost: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removePost"\] = ...
...
*   Defined in [src/resolvers/Mutation/removePost.ts:21](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removePost.ts#L21)
