directChatsMessagesByChatID | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [directChatsMessagesByChatID](resolvers_Query_directChatsMessagesByChatID.directChatsMessagesByChatID.html)

Variable directChatsMessagesByChatID`Const`
===========================================

directChatsMessagesByChatID: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["directChatsMessagesByChatID"\] = ...
...
A `directChatsMessages` object that holds all of the messages from the specified direct chat. If the `directChatsMessages` object is null then it throws `NotFoundError` error.

#### Remarks

You can learn about GraphQL `Resolvers` [here](https://www.apollographql.com/docs/apollo-server/data/resolvers/).

*   Defined in [src/resolvers/Query/directChatsMessagesByChatID.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/directChatsMessagesByChatID.ts#L14)
