unregisterForEventByUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [unregisterForEventByUser](resolvers_Mutation_unregisterForEventByUser.unregisterForEventByUser.html)

Variable unregisterForEventByUser`Const`
========================================

unregisterForEventByUser: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["unregisterForEventByUser"\] = ...
...
*   Defined in [src/resolvers/Mutation/unregisterForEventByUser.ts:20](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/unregisterForEventByUser.ts#L20)
