projectId | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable projectId`Const`
=========================

projectId: undefined | string = ENV.projectId

*   Defined in [src/constants.ts:331](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L331)
