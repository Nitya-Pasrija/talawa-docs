createComment | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createComment](resolvers_Mutation_createComment.createComment.html)

Variable createComment`Const`
=============================

createComment: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createComment"\] = ...
...
*   Defined in [src/resolvers/Mutation/createComment.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/createComment.ts#L15)
