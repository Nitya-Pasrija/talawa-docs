directMessageChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [directMessageChat](resolvers_Subscription_directMessageChat.directMessageChat.html)

Variable directMessageChat`Const`
=================================

directMessageChat: [SubscriptionResolvers](../types/types_generatedGraphQLTypes.SubscriptionResolvers.html)\["directMessageChat"\] = ...
...
*   Defined in [src/resolvers/Subscription/directMessageChat.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Subscription/directMessageChat.ts#L12)
