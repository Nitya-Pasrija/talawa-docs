...
*   [creator](resolvers_Comment_creator.creator.html)

Variable creator`Const`
=======================

creator: [CommentResolvers](../types/types_generatedGraphQLTypes.CommentResolvers.html)\["creator"\] = ...

*   Defined in [src/resolvers/Comment/creator.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Comment/creator.ts#L4)
