...
*   [UserTag](resolvers_UserTag.UserTag.html)

Variable UserTag`Const`
=======================

UserTag: [UserTagResolvers](../types/types_generatedGraphQLTypes.UserTagResolvers.html) = ...

*   Defined in [src/resolvers/UserTag/index.ts:7](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/UserTag/index.ts#L7)
