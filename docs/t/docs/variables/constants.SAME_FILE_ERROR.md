SAME\_FILE\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable SAME\_FILE\_ERROR`Const`
=================================
...
*   Defined in [src/constants.ts:95](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L95)
