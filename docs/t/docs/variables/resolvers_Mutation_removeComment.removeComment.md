removeComment | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeComment](resolvers_Mutation_removeComment.removeComment.html)

Variable removeComment`Const`
=============================

removeComment: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeComment"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeComment.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeComment.ts#L22)
