...
*   [GroupChat](models_GroupChat.GroupChat.html)

Variable GroupChat`Const`
=========================

GroupChat: Model<[InterfaceGroupChat](../interfaces/models_GroupChat.InterfaceGroupChat.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/GroupChat.ts:67](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/GroupChat.ts#L67)
