likeComment | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [likeComment](resolvers_Mutation_likeComment.likeComment.html)

Variable likeComment`Const`
===========================

likeComment: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["likeComment"\] = ...
...
*   Defined in [src/resolvers/Mutation/likeComment.ts:16](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/likeComment.ts#L16)
