...
*   [user](resolvers_Query_user.user.html)

Variable user`Const`
====================

user: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["user"\] = ...
...
*   Defined in [src/resolvers/Query/user.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/user.ts#L12)
