REGISTRANT\_ALREADY\_EXIST\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable REGISTRANT\_ALREADY\_EXIST\_ERROR`Const`
=================================================
...
*   Defined in [src/constants.ts:82](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L82)
