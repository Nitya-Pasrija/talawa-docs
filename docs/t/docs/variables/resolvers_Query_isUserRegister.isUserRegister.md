isUserRegister | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [isUserRegister](resolvers_Query_isUserRegister.isUserRegister.html)

Variable isUserRegister`Const`
==============================

isUserRegister: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["isUserRegister"\] = ...
...
*   Defined in [src/resolvers/Query/isUserRegister.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/isUserRegister.ts#L13)
