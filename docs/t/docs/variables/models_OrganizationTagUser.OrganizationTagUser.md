OrganizationTagUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [OrganizationTagUser](models_OrganizationTagUser.OrganizationTagUser.html)

Variable OrganizationTagUser`Const`
===================================

OrganizationTagUser: Model<[InterfaceOrganizationTagUser](../interfaces/models_OrganizationTagUser.InterfaceOrganizationTagUser.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/OrganizationTagUser.ts:45](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/OrganizationTagUser.ts#L45)
