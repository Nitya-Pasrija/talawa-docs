eventsByOrganization | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [eventsByOrganization](resolvers_Query_eventsByOrganization.eventsByOrganization.html)

Variable eventsByOrganization`Const`
====================================

eventsByOrganization: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["eventsByOrganization"\] = ...
...
*   Defined in [src/resolvers/Query/eventsByOrganization.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/eventsByOrganization.ts#L12)
