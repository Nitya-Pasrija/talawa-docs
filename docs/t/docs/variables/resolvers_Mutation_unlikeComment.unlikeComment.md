unlikeComment | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [unlikeComment](resolvers_Mutation_unlikeComment.unlikeComment.html)

Variable unlikeComment`Const`
=============================

unlikeComment: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["unlikeComment"\] = ...
...
*   Defined in [src/resolvers/Mutation/unlikeComment.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/unlikeComment.ts#L15)
