addLanguageTranslation | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [addLanguageTranslation](resolvers_Mutation_addLanguageTranslation.addLanguageTranslation.html)

Variable addLanguageTranslation`Const`
======================================

addLanguageTranslation: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["addLanguageTranslation"\] = ...
...
*   Defined in [src/resolvers/Mutation/addLanguageTranslation.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/addLanguageTranslation.ts#L14)
