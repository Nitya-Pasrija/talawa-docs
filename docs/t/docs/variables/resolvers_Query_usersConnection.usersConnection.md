...
*   [usersConnection](resolvers_Query_usersConnection.usersConnection.html)

Variable usersConnection`Const`
===============================

usersConnection: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["usersConnection"\] = ...
...
*   Defined in [src/resolvers/Query/usersConnection.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/usersConnection.ts#L15)
