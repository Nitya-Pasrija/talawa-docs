INVALID\_OTP | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable INVALID\_OTP`Const`
============================

INVALID\_OTP: "Invalid OTP" = "Invalid OTP"

*   Defined in [src/constants.ts:34](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L34)
