signUp | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [signUp](resolvers_Mutation_signUp.signUp.html)

Variable signUp`Const`
======================

signUp: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["signUp"\] = ...
...
*   Defined in [src/resolvers/Mutation/signUp.ts:27](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/signUp.ts#L27)
