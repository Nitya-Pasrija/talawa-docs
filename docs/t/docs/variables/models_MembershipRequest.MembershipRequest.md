MembershipRequest | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [MembershipRequest](models_MembershipRequest.MembershipRequest.html)

Variable MembershipRequest`Const`
=================================

MembershipRequest: Model<[InterfaceMembershipRequest](../interfaces/models_MembershipRequest.InterfaceMembershipRequest.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/MembershipRequest.ts:45](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/MembershipRequest.ts#L45)
