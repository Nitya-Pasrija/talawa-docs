...
*   [MessageChat](models_MessageChat.MessageChat.html)

Variable MessageChat`Const`
===========================

MessageChat: Model<[InterfaceMessageChat](../interfaces/models_MessageChat.InterfaceMessageChat.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/MessageChat.ts:54](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/MessageChat.ts#L54)
