...
*   [messages](resolvers_DirectChat_messages.messages.html)

Variable messages`Const`
========================

messages: [DirectChatResolvers](../types/types_generatedGraphQLTypes.DirectChatResolvers.html)\["messages"\] = ...
...
*   Defined in [src/resolvers/DirectChat/messages.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/DirectChat/messages.ts#L8)
