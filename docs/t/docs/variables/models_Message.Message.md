...
*   [Message](models_Message.Message.html)

Variable Message`Const`
=======================

Message: Model<[InterfaceMessage](../interfaces/models_Message.InterfaceMessage.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/Message.ts:67](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L67)
