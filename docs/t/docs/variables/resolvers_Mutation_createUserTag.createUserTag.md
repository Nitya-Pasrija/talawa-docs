createUserTag | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createUserTag](resolvers_Mutation_createUserTag.createUserTag.html)

Variable createUserTag`Const`
=============================

createUserTag: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createUserTag"\] = ...

*   Defined in [src/resolvers/Mutation/createUserTag.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/createUserTag.ts#L13)
