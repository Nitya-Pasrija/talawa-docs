ORGANIZATION\_NOT\_AUTHORIZED\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable ORGANIZATION\_NOT\_AUTHORIZED\_ERROR`Const`
====================================================
...
*   Defined in [src/constants.ts:58](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L58)
