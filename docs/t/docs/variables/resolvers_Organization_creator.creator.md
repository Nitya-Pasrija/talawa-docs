creator | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [creator](resolvers_Organization_creator.creator.html)

Variable creator`Const`
=======================

creator: [OrganizationResolvers](../types/types_generatedGraphQLTypes.OrganizationResolvers.html)\["creator"\] = ...
...
*   Defined in [src/resolvers/Organization/creator.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Organization/creator.ts#L10)
