BASE\_URL | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable BASE\_URL`Const`
=========================

BASE\_URL: string = ...

*   Defined in [src/constants.ts:311](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L311)
