updatePost | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [updatePost](resolvers_Mutation_updatePost.updatePost.html)

Variable updatePost`Const`
==========================

updatePost: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["updatePost"\] = ...

*   Defined in [src/resolvers/Mutation/updatePost.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/updatePost.ts#L12)
