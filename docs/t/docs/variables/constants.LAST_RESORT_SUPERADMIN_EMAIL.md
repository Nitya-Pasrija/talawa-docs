LAST\_RESORT\_SUPERADMIN\_EMAIL | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable LAST\_RESORT\_SUPERADMIN\_EMAIL`Const`
===============================================

LAST\_RESORT\_SUPERADMIN\_EMAIL: undefined | string = process.env.LAST\_RESORT\_SUPERADMIN\_EMAIL

*   Defined in [src/constants.ts:349](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L349)
