types | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [types](typeDefs_types.types.html)
...
*   Defined in [src/typeDefs/types.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/types.ts#L4)
