subscriptions | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [subscriptions](typeDefs_subscriptions.subscriptions.html)

Variable subscriptions`Const`
=============================

subscriptions: DocumentNode = ...

*   Defined in [src/typeDefs/subscriptions.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/subscriptions.ts#L4)
