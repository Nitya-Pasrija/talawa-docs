...
*   [directives](typeDefs_directives.directives.html)

Variable directives`Const`
==========================

directives: DocumentNode = ...

*   Defined in [src/typeDefs/directives.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/directives.ts#L4)
