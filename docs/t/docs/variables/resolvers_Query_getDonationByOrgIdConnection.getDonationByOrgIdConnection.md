getDonationByOrgIdConnection | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [getDonationByOrgIdConnection](resolvers_Query_getDonationByOrgIdConnection.getDonationByOrgIdConnection.html)

Variable getDonationByOrgIdConnection`Const`
============================================
...
*   Defined in [src/resolvers/Query/getDonationByOrgIdConnection.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/getDonationByOrgIdConnection.ts#L6)
