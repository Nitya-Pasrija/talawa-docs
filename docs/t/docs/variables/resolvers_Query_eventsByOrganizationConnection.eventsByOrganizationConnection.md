eventsByOrganizationConnection | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [eventsByOrganizationConnection](resolvers_Query_eventsByOrganizationConnection.eventsByOrganizationConnection.html)

Variable eventsByOrganizationConnection`Const`
==============================================
...
*   Defined in [src/resolvers/Query/eventsByOrganizationConnection.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/eventsByOrganizationConnection.ts#L8)
