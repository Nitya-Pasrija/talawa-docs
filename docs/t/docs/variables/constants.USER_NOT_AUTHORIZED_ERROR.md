USER\_NOT\_AUTHORIZED\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable USER\_NOT\_AUTHORIZED\_ERROR`Const`
============================================
...
*   Defined in [src/constants.ts:262](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L262)
