...
*   [Task](models_Task.Task.html)

Variable Task`Const`
====================

Task: Model<[InterfaceTask](../interfaces/models_Task.InterfaceTask.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/Task.ts:65](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Task.ts#L65)
