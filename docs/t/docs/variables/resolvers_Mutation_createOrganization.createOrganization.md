createOrganization | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createOrganization](resolvers_Mutation_createOrganization.createOrganization.html)

Variable createOrganization`Const`
==================================

createOrganization: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createOrganization"\] = ...
...
*   Defined in [src/resolvers/Mutation/createOrganization.ts:18](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/createOrganization.ts#L18)
