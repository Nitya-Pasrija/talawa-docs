iosBundleId | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable iosBundleId`Const`
===========================

iosBundleId: undefined | string = ENV.iosBundleId

*   Defined in [src/constants.ts:347](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L347)
