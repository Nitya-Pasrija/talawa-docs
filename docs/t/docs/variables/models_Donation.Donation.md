...
*   [Donation](models_Donation.Donation.html)

Variable Donation`Const`
========================

Donation: Model<[InterfaceDonation](../interfaces/models_Donation.InterfaceDonation.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/Donation.ts:54](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Donation.ts#L54)
