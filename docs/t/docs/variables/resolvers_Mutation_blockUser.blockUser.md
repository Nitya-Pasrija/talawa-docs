blockUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [blockUser](resolvers_Mutation_blockUser.blockUser.html)

Variable blockUser`Const`
=========================

blockUser: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["blockUser"\] = ...
...
*   Defined in [src/resolvers/Mutation/blockUser.ts:24](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/blockUser.ts#L24)
