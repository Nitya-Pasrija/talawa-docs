enums | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [enums](typeDefs_enums.enums.html)

Variable enums`Const`
=====================

enums: DocumentNode = ...

*   Defined in [src/typeDefs/enums.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/enums.ts#L4)
