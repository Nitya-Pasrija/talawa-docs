updateTask | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [updateTask](resolvers_Mutation_updateTask.updateTask.html)

Variable updateTask`Const`
==========================

updateTask: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["updateTask"\] = ...
...
*   Defined in [src/resolvers/Mutation/updateTask.ts:19](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/updateTask.ts#L19)
