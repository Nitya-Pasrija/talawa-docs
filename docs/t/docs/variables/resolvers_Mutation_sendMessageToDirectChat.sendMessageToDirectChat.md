sendMessageToDirectChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [sendMessageToDirectChat](resolvers_Mutation_sendMessageToDirectChat.sendMessageToDirectChat.html)

Variable sendMessageToDirectChat`Const`
=======================================

sendMessageToDirectChat: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["sendMessageToDirectChat"\] = ...
...
*   Defined in [src/resolvers/Mutation/sendMessageToDirectChat.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/sendMessageToDirectChat.ts#L15)
