...
*   [Comment](models_Comment.Comment.html)

Variable Comment`Const`
=======================

Comment: Model<[InterfaceComment](../interfaces/models_Comment.InterfaceComment.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/Comment.ts:69](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Comment.ts#L69)
