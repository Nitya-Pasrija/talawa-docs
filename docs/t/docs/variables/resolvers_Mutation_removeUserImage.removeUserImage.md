removeUserImage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeUserImage](resolvers_Mutation_removeUserImage.removeUserImage.html)

Variable removeUserImage`Const`
===============================

removeUserImage: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeUserImage"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeUserImage.ts:19](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeUserImage.ts#L19)
