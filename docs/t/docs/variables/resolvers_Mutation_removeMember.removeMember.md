removeMember | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeMember](resolvers_Mutation_removeMember.removeMember.html)

Variable removeMember`Const`
============================

removeMember: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeMember"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeMember.ts:26](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeMember.ts#L26)
