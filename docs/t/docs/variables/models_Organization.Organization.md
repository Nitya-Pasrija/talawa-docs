...
*   [Organization](models_Organization.Organization.html)

Variable Organization`Const`
============================

Organization: Model<[InterfaceOrganization](../interfaces/models_Organization.InterfaceOrganization.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/Organization.ts:139](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Organization.ts#L139)
