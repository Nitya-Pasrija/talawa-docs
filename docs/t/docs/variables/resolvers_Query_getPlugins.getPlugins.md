getPlugins | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [getPlugins](resolvers_Query_getPlugins.getPlugins.html)

Variable getPlugins`Const`
==========================

getPlugins: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["getPlugins"\] = ...
...
*   Defined in [src/resolvers/Query/getPlugins.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/getPlugins.ts#L8)
