members | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [members](resolvers_Organization_members.members.html)

Variable members`Const`
=======================

members: [OrganizationResolvers](../types/types_generatedGraphQLTypes.OrganizationResolvers.html)\["members"\] = ...
...
*   Defined in [src/resolvers/Organization/members.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Organization/members.ts#L9)
