unions | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [unions](typeDefs_unions.unions.html)

Variable unions`Const`
======================

unions: DocumentNode = ...

*   Defined in [src/typeDefs/unions.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/unions.ts#L4)
