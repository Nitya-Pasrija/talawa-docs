postsByOrganization | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [postsByOrganization](resolvers_Query_postsByOrganization.postsByOrganization.html)

Variable postsByOrganization`Const`
===================================

postsByOrganization: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["postsByOrganization"\] = ...
...
An object that contains the Post.

#### Remarks

The query function uses `getSort()` function to sort the data in specified order.

*   Defined in [src/resolvers/Query/postsByOrganization.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/postsByOrganization.ts#L13)
