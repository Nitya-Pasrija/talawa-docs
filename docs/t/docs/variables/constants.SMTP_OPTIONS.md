SMTP\_OPTIONS | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable SMTP\_OPTIONS`Const`
=============================

SMTP\_OPTIONS: {  
    IS\_SMTP: undefined | string;  
    SMTP\_HOST: undefined | string;  
    SMTP\_PASSWORD: undefined | string;  
    SMTP\_PORT: undefined | string;  
    SMTP\_SSL\_TLS: undefined | string;  
...
*   Defined in [src/constants.ts:352](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L352)
