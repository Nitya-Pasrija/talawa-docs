...
Variable iosFirebaseOptions`Const`
==================================
...
*   Defined in [src/config/firebaseConfig.ts:24](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/config/firebaseConfig.ts#L24)
