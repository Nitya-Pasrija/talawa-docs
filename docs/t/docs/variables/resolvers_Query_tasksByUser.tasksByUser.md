tasksByUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [tasksByUser](resolvers_Query_tasksByUser.tasksByUser.html)

Variable tasksByUser`Const`
===========================

tasksByUser: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["tasksByUser"\] = ...
...
*   Defined in [src/resolvers/Query/tasksByUser.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/tasksByUser.ts#L10)
