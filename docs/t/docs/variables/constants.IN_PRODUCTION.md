IN\_PRODUCTION | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable IN\_PRODUCTION`Const`
==============================

IN\_PRODUCTION: boolean = ...

*   Defined in [src/constants.ts:36](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L36)
