...
*   [User](models_User.User.html)

Variable User`Const`
====================

User: PaginateModel<[InterfaceUser](../interfaces/models_User.InterfaceUser.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/User.ts:182](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L182)
