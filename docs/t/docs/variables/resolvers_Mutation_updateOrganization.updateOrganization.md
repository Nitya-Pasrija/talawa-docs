updateOrganization | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [updateOrganization](resolvers_Mutation_updateOrganization.updateOrganization.html)

Variable updateOrganization`Const`
==================================

updateOrganization: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["updateOrganization"\] = ...
...
*   Defined in [src/resolvers/Mutation/updateOrganization.ts:19](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/updateOrganization.ts#L19)
