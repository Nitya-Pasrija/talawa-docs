...
*   [DirectChat](resolvers_DirectChat.DirectChat.html)

Variable DirectChat`Const`
==========================

DirectChat: [DirectChatResolvers](../types/types_generatedGraphQLTypes.DirectChatResolvers.html) = ...

*   Defined in [src/resolvers/DirectChat/index.ts:7](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/DirectChat/index.ts#L7)
