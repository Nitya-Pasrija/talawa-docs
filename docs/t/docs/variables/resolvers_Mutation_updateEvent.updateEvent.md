updateEvent | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [updateEvent](resolvers_Mutation_updateEvent.updateEvent.html)

Variable updateEvent`Const`
===========================

updateEvent: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["updateEvent"\] = ...
...
*   Defined in [src/resolvers/Mutation/updateEvent.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/updateEvent.ts#L22)
