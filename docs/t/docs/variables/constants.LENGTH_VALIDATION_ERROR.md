LENGTH\_VALIDATION\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable LENGTH\_VALIDATION\_ERROR`Const`
=========================================
...
*   Defined in [src/constants.ts:113](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L113)
