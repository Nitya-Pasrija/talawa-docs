removeUserFromGroupChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeUserFromGroupChat](resolvers_Mutation_removeUserFromGroupChat.removeUserFromGroupChat.html)

Variable removeUserFromGroupChat`Const`
=======================================

removeUserFromGroupChat: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeUserFromGroupChat"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeUserFromGroupChat.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeUserFromGroupChat.ts#L22)
