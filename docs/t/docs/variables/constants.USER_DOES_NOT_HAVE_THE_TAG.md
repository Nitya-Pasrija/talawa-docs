USER\_DOES\_NOT\_HAVE\_THE\_TAG | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable USER\_DOES\_NOT\_HAVE\_THE\_TAG`Const`
===============================================
...
*   Defined in [src/constants.ts:229](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L229)
