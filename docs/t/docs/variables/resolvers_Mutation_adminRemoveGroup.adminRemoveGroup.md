adminRemoveGroup | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [adminRemoveGroup](resolvers_Mutation_adminRemoveGroup.adminRemoveGroup.html)

Variable adminRemoveGroup`Const`
================================

adminRemoveGroup: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["adminRemoveGroup"\] = ...
...
*   Defined in [src/resolvers/Mutation/adminRemoveGroup.ts:23](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/adminRemoveGroup.ts#L23)
