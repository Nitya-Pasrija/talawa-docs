INVALID\_FILE\_TYPE | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable INVALID\_FILE\_TYPE`Const`
===================================
...
*   Defined in [src/constants.ts:89](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L89)
