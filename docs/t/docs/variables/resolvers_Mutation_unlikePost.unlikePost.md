unlikePost | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [unlikePost](resolvers_Mutation_unlikePost.unlikePost.html)

Variable unlikePost`Const`
==========================

unlikePost: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["unlikePost"\] = ...
...
*   Defined in [src/resolvers/Mutation/unlikePost.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/unlikePost.ts#L15)
