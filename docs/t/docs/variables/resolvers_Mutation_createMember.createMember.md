createMember | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createMember](resolvers_Mutation_createMember.createMember.html)

Variable createMember`Const`
============================

createMember: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createMember"\] = ...
...
*   Defined in [src/resolvers/Mutation/createMember.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/createMember.ts#L22)
