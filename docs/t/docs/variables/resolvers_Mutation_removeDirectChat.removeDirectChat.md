removeDirectChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeDirectChat](resolvers_Mutation_removeDirectChat.removeDirectChat.html)

Variable removeDirectChat`Const`
================================

removeDirectChat: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeDirectChat"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeDirectChat.ts:20](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeDirectChat.ts#L20)
