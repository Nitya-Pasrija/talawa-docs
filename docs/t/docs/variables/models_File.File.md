File | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [File](models_File.File.html)

Variable File`Const`
====================

File: Model<[InterfaceFile](../interfaces/models_File.InterfaceFile.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/File.ts:63](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/File.ts#L63)
