removeTask | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeTask](resolvers_Mutation_removeTask.removeTask.html)

Variable removeTask`Const`
==========================

removeTask: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeTask"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeTask.ts:20](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeTask.ts#L20)
