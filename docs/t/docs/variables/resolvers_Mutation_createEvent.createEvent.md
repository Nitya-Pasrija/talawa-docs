createEvent | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createEvent](resolvers_Mutation_createEvent.createEvent.html)

Variable createEvent`Const`
===========================

createEvent: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createEvent"\] = ...
...
*   Defined in [src/resolvers/Mutation/createEvent.ts:31](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/createEvent.ts#L31)
