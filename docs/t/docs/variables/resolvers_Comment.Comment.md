...
*   [Comment](resolvers_Comment.Comment.html)

Variable Comment`Const`
=======================

Comment: [CommentResolvers](../types/types_generatedGraphQLTypes.CommentResolvers.html) = ...

*   Defined in [src/resolvers/Comment/index.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Comment/index.ts#L4)
