storageBucket | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable storageBucket`Const`
=============================

storageBucket: undefined | string = ENV.storageBucket

*   Defined in [src/constants.ts:333](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L333)
