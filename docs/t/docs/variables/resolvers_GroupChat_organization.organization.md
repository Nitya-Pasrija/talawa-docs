...
*   [organization](resolvers_GroupChat_organization.organization.html)

Variable organization`Const`
============================

organization: [GroupChatResolvers](../types/types_generatedGraphQLTypes.GroupChatResolvers.html)\["organization"\] = ...
...
*   Defined in [src/resolvers/GroupChat/organization.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/GroupChat/organization.ts#L8)
