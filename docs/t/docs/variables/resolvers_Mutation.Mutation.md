...
*   [Mutation](resolvers_Mutation.Mutation.html)

Variable Mutation`Const`
========================

Mutation: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html) = ...

*   Defined in [src/resolvers/Mutation/index.ts:78](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/index.ts#L78)
