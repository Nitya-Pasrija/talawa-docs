ACCESS\_TOKEN\_SECRET | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable ACCESS\_TOKEN\_SECRET`Const`
=====================================

ACCESS\_TOKEN\_SECRET: undefined | string = ENV.ACCESS\_TOKEN\_SECRET

*   Defined in [src/constants.ts:313](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L313)
