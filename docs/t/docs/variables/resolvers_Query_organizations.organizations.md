organizations | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [organizations](resolvers_Query_organizations.organizations.html)

Variable organizations`Const`
=============================

organizations: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["organizations"\] = ...
...
*   Defined in [src/resolvers/Query/organizations.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/organizations.ts#L14)
