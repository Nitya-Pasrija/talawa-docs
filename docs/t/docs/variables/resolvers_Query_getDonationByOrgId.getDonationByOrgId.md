getDonationByOrgId | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [getDonationByOrgId](resolvers_Query_getDonationByOrgId.getDonationByOrgId.html)

Variable getDonationByOrgId`Const`
==================================

getDonationByOrgId: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["getDonationByOrgId"\] = ...
...
*   Defined in [src/resolvers/Query/getDonationByOrgId.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/getDonationByOrgId.ts#L10)
