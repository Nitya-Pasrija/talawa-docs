...
*   [Language](models_Language.Language.html)

Variable Language`Const`
========================

Language: Model<[InterfaceLanguage](../interfaces/models_Language.InterfaceLanguage.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/Language.ts:77](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Language.ts#L77)
