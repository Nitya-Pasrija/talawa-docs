myLanguage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [myLanguage](resolvers_Query_myLanguage.myLanguage.html)

Variable myLanguage`Const`
==========================

myLanguage: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["myLanguage"\] = ...
...
*   Defined in [src/resolvers/Query/myLanguage.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/myLanguage.ts#L13)
