RECAPTCHA\_SECRET\_KEY | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable RECAPTCHA\_SECRET\_KEY`Const`
======================================

RECAPTCHA\_SECRET\_KEY: undefined | string = ENV.RECAPTCHA\_SECRET\_KEY

*   Defined in [src/constants.ts:319](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L319)
