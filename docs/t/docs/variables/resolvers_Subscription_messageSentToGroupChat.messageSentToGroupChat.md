messageSentToGroupChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [messageSentToGroupChat](resolvers_Subscription_messageSentToGroupChat.messageSentToGroupChat.html)

Variable messageSentToGroupChat`Const`
======================================

messageSentToGroupChat: [SubscriptionResolvers](../types/types_generatedGraphQLTypes.SubscriptionResolvers.html)\["messageSentToGroupChat"\] = ...
...
*   Defined in [src/resolvers/Subscription/messageSentToGroupChat.ts:35](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Subscription/messageSentToGroupChat.ts#L35)
