iOSmessagingSenderId | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable iOSmessagingSenderId`Const`
====================================

iOSmessagingSenderId: undefined | string = ENV.iOSmessagingSenderId

*   Defined in [src/constants.ts:339](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L339)
