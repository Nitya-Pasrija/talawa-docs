directChatMessageBelongsTo | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [directChatMessageBelongsTo](resolvers_DirectChatMessage_directChatMessageBelongsTo.directChatMessageBelongsTo.html)

Variable directChatMessageBelongsTo`Const`
==========================================

directChatMessageBelongsTo: [DirectChatMessageResolvers](../types/types_generatedGraphQLTypes.DirectChatMessageResolvers.html)\["directChatMessageBelongsTo"\] = ...
...
An `object` that contains the Direct chat data.

*   Defined in [src/resolvers/DirectChatMessage/directChatMessageBelongsTo.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/DirectChatMessage/directChatMessageBelongsTo.ts#L8)
