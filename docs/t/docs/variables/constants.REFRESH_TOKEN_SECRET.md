REFRESH\_TOKEN\_SECRET | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable REFRESH\_TOKEN\_SECRET`Const`
======================================

REFRESH\_TOKEN\_SECRET: undefined | string = ENV.REFRESH\_TOKEN\_SECRET

*   Defined in [src/constants.ts:315](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L315)
