removeUserTag | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeUserTag](resolvers_Mutation_removeUserTag.removeUserTag.html)

Variable removeUserTag`Const`
=============================

removeUserTag: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeUserTag"\] = ...

*   Defined in [src/resolvers/Mutation/removeUserTag.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeUserTag.ts#L10)
