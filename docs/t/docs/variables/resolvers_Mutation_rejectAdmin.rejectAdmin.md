rejectAdmin | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [rejectAdmin](resolvers_Mutation_rejectAdmin.rejectAdmin.html)

Variable rejectAdmin`Const`
===========================

rejectAdmin: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["rejectAdmin"\] = ...
...
*   Defined in [src/resolvers/Mutation/rejectAdmin.ts:17](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/rejectAdmin.ts#L17)
