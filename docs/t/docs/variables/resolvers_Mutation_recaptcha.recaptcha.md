recaptcha | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [recaptcha](resolvers_Mutation_recaptcha.recaptcha.html)

Variable recaptcha`Const`
=========================

recaptcha: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["recaptcha"\] = ...
...
*   Defined in [src/resolvers/Mutation/recaptcha.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/recaptcha.ts#L10)
