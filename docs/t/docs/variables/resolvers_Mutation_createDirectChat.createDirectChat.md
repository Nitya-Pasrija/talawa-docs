createDirectChat | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createDirectChat](resolvers_Mutation_createDirectChat.createDirectChat.html)

Variable createDirectChat`Const`
================================

createDirectChat: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createDirectChat"\] = ...
...
*   Defined in [src/resolvers/Mutation/createDirectChat.ts:18](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/createDirectChat.ts#L18)
