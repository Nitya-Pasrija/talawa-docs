addUserImage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [addUserImage](resolvers_Mutation_addUserImage.addUserImage.html)

Variable addUserImage`Const`
============================

addUserImage: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["addUserImage"\] = ...
...
*   Defined in [src/resolvers/Mutation/addUserImage.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/addUserImage.ts#L15)
