...
*   [event](resolvers_Query_event.event.html)

Variable event`Const`
=====================

event: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["event"\] = ...
...
*   Defined in [src/resolvers/Query/event.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/event.ts#L13)
