login | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [login](resolvers_Mutation_login.login.html)

Variable login`Const`
=====================

login: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["login"\] = ...
...
*   Defined in [src/resolvers/Mutation/login.ts:26](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/login.ts#L26)
