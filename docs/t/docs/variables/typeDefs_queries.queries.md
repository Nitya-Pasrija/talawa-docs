queries | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [queries](typeDefs_queries.queries.html)
...
*   Defined in [src/typeDefs/queries.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/queries.ts#L6)
