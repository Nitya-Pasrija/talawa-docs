pinnedPosts | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [pinnedPosts](resolvers_Organization_pinnedPosts.pinnedPosts.html)

Variable pinnedPosts`Const`
===========================

pinnedPosts: [OrganizationResolvers](../types/types_generatedGraphQLTypes.OrganizationResolvers.html)\["pinnedPosts"\] = ...

*   Defined in [src/resolvers/Organization/pinnedPosts.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Organization/pinnedPosts.ts#L4)
