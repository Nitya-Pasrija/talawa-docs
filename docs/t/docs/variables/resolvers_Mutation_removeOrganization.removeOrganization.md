removeOrganization | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeOrganization](resolvers_Mutation_removeOrganization.removeOrganization.html)

Variable removeOrganization`Const`
==================================

removeOrganization: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeOrganization"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeOrganization.ts:26](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeOrganization.ts#L26)
