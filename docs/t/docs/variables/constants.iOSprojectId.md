iOSprojectId | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable iOSprojectId`Const`
============================

iOSprojectId: undefined | string = ENV.iOSprojectId

*   Defined in [src/constants.ts:341](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L341)
