updateUserProfile | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [updateUserProfile](resolvers_Mutation_updateUserProfile.updateUserProfile.html)

Variable updateUserProfile`Const`
=================================

updateUserProfile: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["updateUserProfile"\] = ...
...
*   Defined in [src/resolvers/Mutation/updateUserProfile.ts:19](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/updateUserProfile.ts#L19)
