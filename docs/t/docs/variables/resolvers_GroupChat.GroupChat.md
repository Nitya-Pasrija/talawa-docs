...
*   [GroupChat](resolvers_GroupChat.GroupChat.html)

Variable GroupChat`Const`
=========================

GroupChat: [GroupChatResolvers](../types/types_generatedGraphQLTypes.GroupChatResolvers.html) = ...

*   Defined in [src/resolvers/GroupChat/index.ts:7](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/GroupChat/index.ts#L7)
