MAIL\_PASSWORD | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable MAIL\_PASSWORD`Const`
==============================

MAIL\_PASSWORD: undefined | string = ENV.MAIL\_PASSWORD

*   Defined in [src/constants.ts:323](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L323)
