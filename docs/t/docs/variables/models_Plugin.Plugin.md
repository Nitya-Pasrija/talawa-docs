...
*   [Plugin](models_Plugin.Plugin.html)

Variable Plugin`Const`
======================

Plugin: Model<[InterfacePlugin](../interfaces/models_Plugin.InterfacePlugin.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/Plugin.ts:54](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Plugin.ts#L54)
