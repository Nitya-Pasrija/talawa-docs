appConfig | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [appConfig](config_appConfig.appConfig.html)

Variable appConfig`Const`
=========================

appConfig: {  
    colorize\_logs: undefined | string;  
