rejectMembershipRequest | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [rejectMembershipRequest](resolvers_Mutation_rejectMembershipRequest.rejectMembershipRequest.html)

Variable rejectMembershipRequest`Const`
=======================================

rejectMembershipRequest: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["rejectMembershipRequest"\] = ...
...
*   Defined in [src/resolvers/Mutation/rejectMembershipRequest.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/rejectMembershipRequest.ts#L22)
