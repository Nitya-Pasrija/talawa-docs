registeredEventsByUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [registeredEventsByUser](resolvers_Query_registeredEventsByUser.registeredEventsByUser.html)

Variable registeredEventsByUser`Const`
======================================

registeredEventsByUser: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["registeredEventsByUser"\] = ...
...
*   Defined in [src/resolvers/Query/registeredEventsByUser.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/registeredEventsByUser.ts#L12)
