createDonation | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createDonation](resolvers_Mutation_createDonation.createDonation.html)

Variable createDonation`Const`
==============================

createDonation: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["createDonation"\] = ...
...
*   Defined in [src/resolvers/Mutation/createDonation.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/createDonation.ts#L11)
