USER\_NOT\_AUTHORIZED\_TO\_PIN | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable USER\_NOT\_AUTHORIZED\_TO\_PIN`Const`
==============================================
...
*   Defined in [src/constants.ts:168](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L168)
