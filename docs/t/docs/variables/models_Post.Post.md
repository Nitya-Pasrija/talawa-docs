...
*   [Post](models_Post.Post.html)

Variable Post`Const`
====================

Post: PaginateModel<[InterfacePost](../interfaces/models_Post.InterfacePost.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/Post.ts:101](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Post.ts#L101)
