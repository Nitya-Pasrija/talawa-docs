EVENT\_PROJECT\_NOT\_FOUND\_ERROR | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable EVENT\_PROJECT\_NOT\_FOUND\_ERROR`Const`
=================================================
...
*   Defined in [src/constants.ts:28](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L28)
