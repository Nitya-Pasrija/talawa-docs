sendMembershipRequest | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [sendMembershipRequest](resolvers_Mutation_sendMembershipRequest.sendMembershipRequest.html)

Variable sendMembershipRequest`Const`
=====================================

sendMembershipRequest: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["sendMembershipRequest"\] = ...
...
*   Defined in [src/resolvers/Mutation/sendMembershipRequest.ts:20](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/sendMembershipRequest.ts#L20)
