acceptAdmin | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [acceptAdmin](resolvers_Mutation_acceptAdmin.acceptAdmin.html)

Variable acceptAdmin`Const`
===========================

acceptAdmin: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["acceptAdmin"\] = ...
...
*   Defined in [src/resolvers/Mutation/acceptAdmin.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/acceptAdmin.ts#L15)
