GroupChatMessage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [GroupChatMessage](models_GroupChatMessage.GroupChatMessage.html)

Variable GroupChatMessage`Const`
================================

GroupChatMessage: Model<[InterfaceGroupChatMessage](../interfaces/models_GroupChatMessage.InterfaceGroupChatMessage.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/GroupChatMessage.ts:55](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/GroupChatMessage.ts#L55)
