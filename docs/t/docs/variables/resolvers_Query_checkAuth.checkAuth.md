checkAuth | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [checkAuth](resolvers_Query_checkAuth.checkAuth.html)

Variable checkAuth`Const`
=========================

checkAuth: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["checkAuth"\] = ...
...
*   Defined in [src/resolvers/Query/checkAuth.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/checkAuth.ts#L13)
