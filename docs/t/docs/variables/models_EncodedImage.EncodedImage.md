EncodedImage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [EncodedImage](models_EncodedImage.EncodedImage.html)

Variable EncodedImage`Const`
============================

EncodedImage: Model<[InterfaceEncodedImage](../interfaces/models_EncodedImage.InterfaceEncodedImage.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/EncodedImage.ts:38](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EncodedImage.ts#L38)
