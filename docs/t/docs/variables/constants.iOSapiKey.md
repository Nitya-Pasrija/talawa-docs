iOSapiKey | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable iOSapiKey`Const`
=========================

iOSapiKey: undefined | string = ENV.iOSapiKey

*   Defined in [src/constants.ts:335](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L335)
