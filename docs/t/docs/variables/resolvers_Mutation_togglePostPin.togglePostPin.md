togglePostPin | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [togglePostPin](resolvers_Mutation_togglePostPin.togglePostPin.html)

Variable togglePostPin`Const`
=============================

togglePostPin: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["togglePostPin"\] = ...

*   Defined in [src/resolvers/Mutation/togglePostPin.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/togglePostPin.ts#L10)
