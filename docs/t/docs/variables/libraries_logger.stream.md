stream | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [stream](libraries_logger.stream.html)

Variable stream`Const`
======================
...
*   Defined in [src/libraries/logger.ts:55](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/logger.ts#L55)
...
*   [libraries/logger](../modules/libraries_logger.html)
    ...
    *   [logger](libraries_logger.logger.html)
    *   [stream](libraries_logger.stream.html)
