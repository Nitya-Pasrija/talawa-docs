EventProject | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [EventProject](models_EventProject.EventProject.html)

Variable EventProject`Const`
============================

EventProject: Model<[InterfaceEventProject](../interfaces/models_EventProject.InterfaceEventProject.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/EventProject.ts:70](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L70)
