userLanguage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [userLanguage](resolvers_Query_userLanguage.userLanguage.html)

Variable userLanguage`Const`
============================

userLanguage: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["userLanguage"\] = ...
...
*   Defined in [src/resolvers/Query/userLanguage.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/userLanguage.ts#L11)
