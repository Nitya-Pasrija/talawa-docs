...
*   Defined in [src/resolvers/MembershipRequest/user.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/MembershipRequest/user.ts#L8)
