...
*   [DirectChat](models_DirectChat.DirectChat.html)

Variable DirectChat`Const`
==========================

DirectChat: Model<[InterfaceDirectChat](../interfaces/models_DirectChat.InterfaceDirectChat.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/DirectChat.ts:61](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/DirectChat.ts#L61)
