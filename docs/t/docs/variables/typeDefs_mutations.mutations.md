mutations | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [mutations](typeDefs_mutations.mutations.html)

Variable mutations`Const`
=========================
...
*   Defined in [src/typeDefs/mutations.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/typeDefs/mutations.ts#L6)
