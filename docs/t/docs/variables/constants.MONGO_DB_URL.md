MONGO\_DB\_URL | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
Variable MONGO\_DB\_URL`Const`
==============================

MONGO\_DB\_URL: undefined | string = ENV.MONGO\_DB\_URL

*   Defined in [src/constants.ts:317](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/constants.ts#L317)
