ImageHash | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [ImageHash](models_ImageHash.ImageHash.html)

Variable ImageHash`Const`
=========================

ImageHash: Model<[InterfaceImageHash](../interfaces/models_ImageHash.InterfaceImageHash.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/ImageHash.ts:46](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/ImageHash.ts#L46)
