refreshToken | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [refreshToken](resolvers_Mutation_refreshToken.refreshToken.html)

Variable refreshToken`Const`
============================

refreshToken: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["refreshToken"\] = ...
...
*   Defined in [src/resolvers/Mutation/refreshToken.ts:19](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/refreshToken.ts#L19)
