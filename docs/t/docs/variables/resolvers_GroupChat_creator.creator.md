...
*   [creator](resolvers_GroupChat_creator.creator.html)

Variable creator`Const`
=======================

creator: [GroupChatResolvers](../types/types_generatedGraphQLTypes.GroupChatResolvers.html)\["creator"\] = ...
...
*   Defined in [src/resolvers/GroupChat/creator.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/GroupChat/creator.ts#L8)
