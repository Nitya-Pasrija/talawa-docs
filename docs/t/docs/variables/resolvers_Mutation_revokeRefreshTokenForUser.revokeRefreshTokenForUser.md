revokeRefreshTokenForUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [revokeRefreshTokenForUser](resolvers_Mutation_revokeRefreshTokenForUser.revokeRefreshTokenForUser.html)

Variable revokeRefreshTokenForUser`Const`
=========================================

revokeRefreshTokenForUser: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["revokeRefreshTokenForUser"\] = ...
...
*   Defined in [src/resolvers/Mutation/revokeRefreshTokenForUser.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/revokeRefreshTokenForUser.ts#L9)
