TagUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [TagUser](models_TagUser.TagUser.html)

Variable TagUser`Const`
=======================

TagUser: Model<[InterfaceTagUser](../interfaces/models_TagUser.InterfaceTagUser.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/TagUser.ts:32](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/TagUser.ts#L32)
