receiver | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [receiver](resolvers_DirectChatMessage_receiver.receiver.html)

Variable receiver`Const`
========================

receiver: [DirectChatMessageResolvers](../types/types_generatedGraphQLTypes.DirectChatMessageResolvers.html)\["receiver"\] = ...
...
*   Defined in [src/resolvers/DirectChatMessage/receiver.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/DirectChatMessage/receiver.ts#L8)
