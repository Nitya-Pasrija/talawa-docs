getlanguage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [getlanguage](resolvers_Query_getlanguage.getlanguage.html)

Variable getlanguage`Const`
===========================

getlanguage: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["getlanguage"\] = ...
...
*   Defined in [src/resolvers/Query/getlanguage.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/getlanguage.ts#L12)
