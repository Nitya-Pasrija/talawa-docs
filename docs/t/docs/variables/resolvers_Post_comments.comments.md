comments | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [comments](resolvers_Post_comments.comments.html)

Variable comments`Const`
========================

comments: [PostResolvers](../types/types_generatedGraphQLTypes.PostResolvers.html)\["comments"\] = ...

*   Defined in [src/resolvers/Post/comments.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Post/comments.ts#L4)
