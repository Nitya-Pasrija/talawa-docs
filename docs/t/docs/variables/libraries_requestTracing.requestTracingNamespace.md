requestTracingNamespace | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [requestTracingNamespace](libraries_requestTracing.requestTracingNamespace.html)

Variable requestTracingNamespace`Const`
=======================================

requestTracingNamespace: Namespace = ...

*   Defined in [src/libraries/requestTracing.ts:17](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/requestTracing.ts#L17)
...
*   [libraries/requestTracing](../modules/libraries_requestTracing.html)
    ...
    *   [requestTracingNamespace](libraries_requestTracing.requestTracingNamespace.html)
    *   [tracingIdHeaderName](libraries_requestTracing.tracingIdHeaderName.html)
