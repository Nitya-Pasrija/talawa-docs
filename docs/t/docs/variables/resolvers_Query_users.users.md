...
*   [users](resolvers_Query_users.users.html)

Variable users`Const`
=====================

users: [QueryResolvers](../types/types_generatedGraphQLTypes.QueryResolvers.html)\["users"\] = ...
...
*   Defined in [src/resolvers/Query/users.ts:17](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/users.ts#L17)
