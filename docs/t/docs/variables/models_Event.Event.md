Event | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [Event](models_Event.Event.html)

Variable Event`Const`
=====================

Event: Model<[InterfaceEvent](../interfaces/models_Event.InterfaceEvent.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/Event.ts:204](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Event.ts#L204)
