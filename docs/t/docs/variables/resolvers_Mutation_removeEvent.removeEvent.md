removeEvent | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeEvent](resolvers_Mutation_removeEvent.removeEvent.html)

Variable removeEvent`Const`
===========================

removeEvent: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["removeEvent"\] = ...
...
*   Defined in [src/resolvers/Mutation/removeEvent.ts:21](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeEvent.ts#L21)
