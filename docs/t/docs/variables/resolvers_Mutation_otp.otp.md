otp | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [otp](resolvers_Mutation_otp.otp.html)

Variable otp`Const`
===================

otp: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["otp"\] = ...
...
*   Defined in [src/resolvers/Mutation/otp.ts:16](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/otp.ts#L16)
