requestContextNamespace | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [requestContextNamespace](libraries_requestContext.requestContextNamespace.html)

Variable requestContextNamespace`Const`
=======================================

requestContextNamespace: Namespace = ...

*   Defined in [src/libraries/requestContext.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/requestContext.ts#L8)
