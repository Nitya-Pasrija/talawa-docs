updatePluginInstalledOrgs | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [updatePluginInstalledOrgs](resolvers_Mutation_updatePluginInstalledOrgs.updatePluginInstalledOrgs.html)

Variable updatePluginInstalledOrgs`Const`
=========================================

updatePluginInstalledOrgs: [MutationResolvers](../types/types_generatedGraphQLTypes.MutationResolvers.html)\["updatePluginInstalledOrgs"\] = ...
...
*   Defined in [src/resolvers/Mutation/updatePluginInstalledOrgs.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/updatePluginInstalledOrgs.ts#L12)
