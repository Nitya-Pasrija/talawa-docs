PluginField | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [PluginField](models_PluginField.PluginField.html)

Variable PluginField`Const`
===========================

PluginField: Model<[InterfacePluginField](../interfaces/models_PluginField.InterfacePluginField.html), {}, {}\> = ...

#### Type declaration

#### Type declaration

*   Defined in [src/models/PluginField.ts:45](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/PluginField.ts#L45)
