parentTag | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [parentTag](resolvers_UserTag_parentTag.parentTag.html)

Variable parentTag`Const`
=========================

parentTag: [UserTagResolvers](../types/types_generatedGraphQLTypes.UserTagResolvers.html)\["parentTag"\] = ...

*   Defined in [src/resolvers/UserTag/parentTag.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/UserTag/parentTag.ts#L4)
