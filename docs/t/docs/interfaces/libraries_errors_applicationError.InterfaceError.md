InterfaceError | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [InterfaceError](libraries_errors_applicationError.InterfaceError.html)
...
*   Defined in [src/libraries/errors/applicationError.ts:1](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/applicationError.ts#L1)

##### Index

### Properties

[code](libraries_errors_applicationError.InterfaceError.html#code) [message](libraries_errors_applicationError.InterfaceError.html#message) [metadata?](libraries_errors_applicationError.InterfaceError.html#metadata) [param](libraries_errors_applicationError.InterfaceError.html#param)
...
*   Defined in [src/libraries/errors/applicationError.ts:3](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/applicationError.ts#L3)

### message[](#message)

message: string

*   Defined in [src/libraries/errors/applicationError.ts:2](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/applicationError.ts#L2)

### `Optional` metadata[](#metadata)

metadata?: Record<any, any\>

*   Defined in [src/libraries/errors/applicationError.ts:5](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/applicationError.ts#L5)

### param[](#param)

param: null | string

*   Defined in [src/libraries/errors/applicationError.ts:4](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/errors/applicationError.ts#L4)
...
*   [libraries/errors/applicationError](../modules/libraries_errors_applicationError.html)
    ...
    *   [ApplicationError](../classes/libraries_errors_applicationError.ApplicationError.html)
    *   [InterfaceError](libraries_errors_applicationError.InterfaceError.html)
