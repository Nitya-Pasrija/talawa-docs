InterfaceEventProject | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [InterfaceEventProject](models_EventProject.InterfaceEventProject.html)
...
*   Defined in [src/models/EventProject.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L9)

##### Index

### Properties

[\_id](models_EventProject.InterfaceEventProject.html#_id) [createdAt](models_EventProject.InterfaceEventProject.html#createdAt) [creator](models_EventProject.InterfaceEventProject.html#creator) [description](models_EventProject.InterfaceEventProject.html#description) [event](models_EventProject.InterfaceEventProject.html#event) [status](models_EventProject.InterfaceEventProject.html#status) [tasks](models_EventProject.InterfaceEventProject.html#tasks) [title](models_EventProject.InterfaceEventProject.html#title)
...
*   Defined in [src/models/EventProject.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L10)

### createdAt[](#createdAt)

createdAt: Date

*   Defined in [src/models/EventProject.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L13)

### creator[](#creator)

creator: any

*   Defined in [src/models/EventProject.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L15)

### description[](#description)

description: string

*   Defined in [src/models/EventProject.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L12)

### event[](#event)

event: any

*   Defined in [src/models/EventProject.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L14)

### status[](#status)

status: string

*   Defined in [src/models/EventProject.ts:17](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L17)

### tasks[](#tasks)

tasks: any\[\]

*   Defined in [src/models/EventProject.ts:16](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L16)

### title[](#title)

title: string

*   Defined in [src/models/EventProject.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/EventProject.ts#L11)
...
*   [models/EventProject](../modules/models_EventProject.html)
    ...
    *   [InterfaceEventProject](models_EventProject.InterfaceEventProject.html)
    *   [EventProject](../variables/models_EventProject.EventProject.html)
