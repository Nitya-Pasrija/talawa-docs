InterfaceComment | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [InterfaceComment](models_Comment.InterfaceComment.html)
...
*   Defined in [src/models/Comment.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Comment.ts#L8)

##### Index

### Properties

[\_id](models_Comment.InterfaceComment.html#_id) [createdAt](models_Comment.InterfaceComment.html#createdAt) [creator](models_Comment.InterfaceComment.html#creator) [likeCount](models_Comment.InterfaceComment.html#likeCount) [likedBy](models_Comment.InterfaceComment.html#likedBy) [postId](models_Comment.InterfaceComment.html#postId) [status](models_Comment.InterfaceComment.html#status) [text](models_Comment.InterfaceComment.html#text)
...
*   Defined in [src/models/Comment.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Comment.ts#L9)

### createdAt[](#createdAt)

createdAt: Date

*   Defined in [src/models/Comment.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Comment.ts#L11)

### creator[](#creator)

creator: any

*   Defined in [src/models/Comment.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Comment.ts#L13)

### likeCount[](#likeCount)

likeCount: number

*   Defined in [src/models/Comment.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Comment.ts#L15)

### likedBy[](#likedBy)

likedBy: any\[\]

*   Defined in [src/models/Comment.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Comment.ts#L14)

### postId[](#postId)

postId: any

*   Defined in [src/models/Comment.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Comment.ts#L12)

### status[](#status)

status: string

*   Defined in [src/models/Comment.ts:16](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Comment.ts#L16)

### text[](#text)

text: string

*   Defined in [src/models/Comment.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Comment.ts#L10)
...
*   [models/Comment](../modules/models_Comment.html)
    ...
    *   [InterfaceComment](models_Comment.InterfaceComment.html)
    *   [Comment](../variables/models_Comment.Comment.html)
