InterfaceGroupChatMessage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [InterfaceGroupChatMessage](models_GroupChatMessage.InterfaceGroupChatMessage.html)
...
*   Defined in [src/models/GroupChatMessage.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/GroupChatMessage.ts#L8)

##### Index

### Properties

[\_id](models_GroupChatMessage.InterfaceGroupChatMessage.html#_id) [createdAt](models_GroupChatMessage.InterfaceGroupChatMessage.html#createdAt) [groupChatMessageBelongsTo](models_GroupChatMessage.InterfaceGroupChatMessage.html#groupChatMessageBelongsTo) [messageContent](models_GroupChatMessage.InterfaceGroupChatMessage.html#messageContent) [sender](models_GroupChatMessage.InterfaceGroupChatMessage.html#sender) [status](models_GroupChatMessage.InterfaceGroupChatMessage.html#status)
...
*   Defined in [src/models/GroupChatMessage.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/GroupChatMessage.ts#L9)

### createdAt[](#createdAt)

createdAt: Date

*   Defined in [src/models/GroupChatMessage.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/GroupChatMessage.ts#L12)

### groupChatMessageBelongsTo[](#groupChatMessageBelongsTo)

groupChatMessageBelongsTo: any

*   Defined in [src/models/GroupChatMessage.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/GroupChatMessage.ts#L10)

### messageContent[](#messageContent)

messageContent: string

*   Defined in [src/models/GroupChatMessage.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/GroupChatMessage.ts#L13)

### sender[](#sender)

sender: any

*   Defined in [src/models/GroupChatMessage.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/GroupChatMessage.ts#L11)

### status[](#status)

status: string

*   Defined in [src/models/GroupChatMessage.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/GroupChatMessage.ts#L14)
...
*   [models/GroupChatMessage](../modules/models_GroupChatMessage.html)
    ...
    *   [InterfaceGroupChatMessage](models_GroupChatMessage.InterfaceGroupChatMessage.html)
    *   [GroupChatMessage](../variables/models_GroupChatMessage.GroupChatMessage.html)
