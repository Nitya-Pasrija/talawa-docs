InterfaceMessage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [InterfaceMessage](models_Message.InterfaceMessage.html)
...
*   Defined in [src/models/Message.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L8)

##### Index

### Properties

[\_id](models_Message.InterfaceMessage.html#_id) [createdAt](models_Message.InterfaceMessage.html#createdAt) [creator](models_Message.InterfaceMessage.html#creator) [group](models_Message.InterfaceMessage.html#group) [imageUrl](models_Message.InterfaceMessage.html#imageUrl) [status](models_Message.InterfaceMessage.html#status) [text](models_Message.InterfaceMessage.html#text) [videoUrl](models_Message.InterfaceMessage.html#videoUrl)
...
*   Defined in [src/models/Message.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L9)

### createdAt[](#createdAt)

createdAt: Date

*   Defined in [src/models/Message.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L13)

### creator[](#creator)

creator: any

*   Defined in [src/models/Message.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L14)

### group[](#group)

group: any

*   Defined in [src/models/Message.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L15)

### imageUrl[](#imageUrl)

imageUrl: undefined | string

*   Defined in [src/models/Message.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L11)

### status[](#status)

status: string

*   Defined in [src/models/Message.ts:16](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L16)

### text[](#text)

text: string

*   Defined in [src/models/Message.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L10)

### videoUrl[](#videoUrl)

videoUrl: undefined | string

*   Defined in [src/models/Message.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Message.ts#L12)
...
*   [models/Message](../modules/models_Message.html)
    ...
    *   [InterfaceMessage](models_Message.InterfaceMessage.html)
    *   [Message](../variables/models_Message.Message.html)
