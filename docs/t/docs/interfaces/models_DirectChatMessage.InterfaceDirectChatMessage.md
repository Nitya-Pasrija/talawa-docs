InterfaceDirectChatMessage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [InterfaceDirectChatMessage](models_DirectChatMessage.InterfaceDirectChatMessage.html)
...
*   Defined in [src/models/DirectChatMessage.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/DirectChatMessage.ts#L8)

##### Index

### Properties

[\_id](models_DirectChatMessage.InterfaceDirectChatMessage.html#_id) [createdAt](models_DirectChatMessage.InterfaceDirectChatMessage.html#createdAt) [directChatMessageBelongsTo](models_DirectChatMessage.InterfaceDirectChatMessage.html#directChatMessageBelongsTo) [messageContent](models_DirectChatMessage.InterfaceDirectChatMessage.html#messageContent) [receiver](models_DirectChatMessage.InterfaceDirectChatMessage.html#receiver) [sender](models_DirectChatMessage.InterfaceDirectChatMessage.html#sender) [status](models_DirectChatMessage.InterfaceDirectChatMessage.html#status)
...
*   Defined in [src/models/DirectChatMessage.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/DirectChatMessage.ts#L9)

### createdAt[](#createdAt)

createdAt: Date

*   Defined in [src/models/DirectChatMessage.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/DirectChatMessage.ts#L13)

### directChatMessageBelongsTo[](#directChatMessageBelongsTo)

directChatMessageBelongsTo: any

*   Defined in [src/models/DirectChatMessage.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/DirectChatMessage.ts#L10)

### messageContent[](#messageContent)

messageContent: string

*   Defined in [src/models/DirectChatMessage.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/DirectChatMessage.ts#L14)

### receiver[](#receiver)

receiver: any

*   Defined in [src/models/DirectChatMessage.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/DirectChatMessage.ts#L12)

### sender[](#sender)

sender: any

*   Defined in [src/models/DirectChatMessage.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/DirectChatMessage.ts#L11)

### status[](#status)

status: string

*   Defined in [src/models/DirectChatMessage.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/DirectChatMessage.ts#L15)
...
*   [models/DirectChatMessage](../modules/models_DirectChatMessage.html)
    ...
    *   [InterfaceDirectChatMessage](models_DirectChatMessage.InterfaceDirectChatMessage.html)
    *   [DirectChatMessage](../variables/models_DirectChatMessage.DirectChatMessage.html)
