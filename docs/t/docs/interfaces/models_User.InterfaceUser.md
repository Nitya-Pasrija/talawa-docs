InterfaceUser | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [InterfaceUser](models_User.InterfaceUser.html)
...
*   Defined in [src/models/User.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L11)

##### Index

### Properties

[\_id](models_User.InterfaceUser.html#_id) [adminApproved](models_User.InterfaceUser.html#adminApproved) [adminFor](models_User.InterfaceUser.html#adminFor) [appLanguageCode](models_User.InterfaceUser.html#appLanguageCode) [createdAt](models_User.InterfaceUser.html#createdAt) [createdEvents](models_User.InterfaceUser.html#createdEvents) [createdOrganizations](models_User.InterfaceUser.html#createdOrganizations) [email](models_User.InterfaceUser.html#email) [eventAdmin](models_User.InterfaceUser.html#eventAdmin) [firstName](models_User.InterfaceUser.html#firstName) [image](models_User.InterfaceUser.html#image) [joinedOrganizations](models_User.InterfaceUser.html#joinedOrganizations) [lastName](models_User.InterfaceUser.html#lastName) [membershipRequests](models_User.InterfaceUser.html#membershipRequests) [organizationUserBelongsTo](models_User.InterfaceUser.html#organizationUserBelongsTo) [organizationsBlockedBy](models_User.InterfaceUser.html#organizationsBlockedBy) [password](models_User.InterfaceUser.html#password) [pluginCreationAllowed](models_User.InterfaceUser.html#pluginCreationAllowed) [registeredEvents](models_User.InterfaceUser.html#registeredEvents) [status](models_User.InterfaceUser.html#status) [token](models_User.InterfaceUser.html#token) [tokenVersion](models_User.InterfaceUser.html#tokenVersion) [userType](models_User.InterfaceUser.html#userType)
...
*   Defined in [src/models/User.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L12)

### adminApproved[](#adminApproved)

adminApproved: boolean

*   Defined in [src/models/User.ts:35](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L35)

### adminFor[](#adminFor)

adminFor: any\[\]

*   Defined in [src/models/User.ts:27](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L27)

### appLanguageCode[](#appLanguageCode)

appLanguageCode: string

*   Defined in [src/models/User.ts:20](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L20)

### createdAt[](#createdAt)

createdAt: Date

*   Defined in [src/models/User.ts:36](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L36)

### createdEvents[](#createdEvents)

createdEvents: any\[\]

*   Defined in [src/models/User.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L22)

### createdOrganizations[](#createdOrganizations)

createdOrganizations: any\[\]

*   Defined in [src/models/User.ts:21](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L21)

### email[](#email)

email: string

*   Defined in [src/models/User.ts:18](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L18)

### eventAdmin[](#eventAdmin)

eventAdmin: any\[\]

*   Defined in [src/models/User.ts:26](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L26)

### firstName[](#firstName)

firstName: string

*   Defined in [src/models/User.ts:16](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L16)

### image[](#image)

image: undefined | null | string

*   Defined in [src/models/User.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L13)

### joinedOrganizations[](#joinedOrganizations)

joinedOrganizations: any\[\]

*   Defined in [src/models/User.ts:24](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L24)

### lastName[](#lastName)

lastName: string

*   Defined in [src/models/User.ts:17](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L17)

### membershipRequests[](#membershipRequests)

membershipRequests: any\[\]

*   Defined in [src/models/User.ts:28](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L28)

### organizationUserBelongsTo[](#organizationUserBelongsTo)

organizationUserBelongsTo: any

*   Defined in [src/models/User.ts:31](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L31)

### organizationsBlockedBy[](#organizationsBlockedBy)

organizationsBlockedBy: any\[\]

*   Defined in [src/models/User.ts:29](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L29)

### password[](#password)

password: string

*   Defined in [src/models/User.ts:19](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L19)

### pluginCreationAllowed[](#pluginCreationAllowed)

pluginCreationAllowed: boolean

*   Defined in [src/models/User.ts:34](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L34)

### registeredEvents[](#registeredEvents)

registeredEvents: any\[\]

*   Defined in [src/models/User.ts:25](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L25)

### status[](#status)

status: string

*   Defined in [src/models/User.ts:30](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L30)

### token[](#token)

token: undefined | string

*   Defined in [src/models/User.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L14)

### tokenVersion[](#tokenVersion)

tokenVersion: number

*   Defined in [src/models/User.ts:15](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L15)

### userType[](#userType)

userType: string

*   Defined in [src/models/User.ts:23](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/User.ts#L23)
...
*   [models/User](../modules/models_User.html)
    ...
    *   [InterfaceUser](models_User.InterfaceUser.html)
    *   [User](../variables/models_User.User.html)
