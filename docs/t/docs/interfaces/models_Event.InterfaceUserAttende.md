InterfaceUserAttende | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   Defined in [src/models/Event.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Event.ts#L9)

##### Index

### Properties

[createdAt](models_Event.InterfaceUserAttende.html#createdAt) [status](models_Event.InterfaceUserAttende.html#status) [user](models_Event.InterfaceUserAttende.html#user) [userId](models_Event.InterfaceUserAttende.html#userId)
...
*   Defined in [src/models/Event.ts:13](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Event.ts#L13)

### status[](#status)

status: string

*   Defined in [src/models/Event.ts:12](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Event.ts#L12)

### user[](#user)

user: any

*   Defined in [src/models/Event.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Event.ts#L11)

### userId[](#userId)

userId: string

*   Defined in [src/models/Event.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/Event.ts#L10)
