InterfaceJwtTokenPayload | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [InterfaceJwtTokenPayload](utilities_auth.InterfaceJwtTokenPayload.html)
...
*   Defined in [src/utilities/auth.ts:5](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/auth.ts#L5)

##### Index

### Properties

[email](utilities_auth.InterfaceJwtTokenPayload.html#email) [firstName](utilities_auth.InterfaceJwtTokenPayload.html#firstName) [lastName](utilities_auth.InterfaceJwtTokenPayload.html#lastName) [tokenVersion](utilities_auth.InterfaceJwtTokenPayload.html#tokenVersion) [userId](utilities_auth.InterfaceJwtTokenPayload.html#userId)
...
*   Defined in [src/utilities/auth.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/auth.ts#L10)

### firstName[](#firstName)

firstName: string

*   Defined in [src/utilities/auth.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/auth.ts#L8)

### lastName[](#lastName)

lastName: string

*   Defined in [src/utilities/auth.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/auth.ts#L9)

### tokenVersion[](#tokenVersion)

tokenVersion: number

*   Defined in [src/utilities/auth.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/auth.ts#L6)

### userId[](#userId)

userId: string

*   Defined in [src/utilities/auth.ts:7](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/auth.ts#L7)
...
*   [utilities/auth](../modules/utilities_auth.html)
    ...
    *   [InterfaceJwtTokenPayload](utilities_auth.InterfaceJwtTokenPayload.html)
    *   [createAccessToken](../functions/utilities_auth.createAccessToken.html)
    *   [createRefreshToken](../functions/utilities_auth.createRefreshToken.html)
