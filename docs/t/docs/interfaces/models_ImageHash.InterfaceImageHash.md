InterfaceImageHash | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [InterfaceImageHash](models_ImageHash.InterfaceImageHash.html)
...
*   Defined in [src/models/ImageHash.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/ImageHash.ts#L6)

##### Index

### Properties

[\_id](models_ImageHash.InterfaceImageHash.html#_id) [fileName](models_ImageHash.InterfaceImageHash.html#fileName) [hashValue](models_ImageHash.InterfaceImageHash.html#hashValue) [numberOfUses](models_ImageHash.InterfaceImageHash.html#numberOfUses) [status](models_ImageHash.InterfaceImageHash.html#status)
...
*   Defined in [src/models/ImageHash.ts:7](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/ImageHash.ts#L7)

### fileName[](#fileName)

fileName: string

*   Defined in [src/models/ImageHash.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/ImageHash.ts#L9)

### hashValue[](#hashValue)

hashValue: string

*   Defined in [src/models/ImageHash.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/ImageHash.ts#L8)

### numberOfUses[](#numberOfUses)

numberOfUses: number

*   Defined in [src/models/ImageHash.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/ImageHash.ts#L10)

### status[](#status)

status: string

*   Defined in [src/models/ImageHash.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/ImageHash.ts#L11)
...
*   [models/ImageHash](../modules/models_ImageHash.html)
    ...
    *   [InterfaceImageHash](models_ImageHash.InterfaceImageHash.html)
    *   [ImageHash](../variables/models_ImageHash.ImageHash.html)
