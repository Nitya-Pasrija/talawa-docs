InterfacePluginField | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [InterfacePluginField](models_PluginField.InterfacePluginField.html)
...
*   Defined in [src/models/PluginField.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/PluginField.ts#L6)

##### Index

### Properties

[\_id](models_PluginField.InterfacePluginField.html#_id) [createdAt](models_PluginField.InterfacePluginField.html#createdAt) [key](models_PluginField.InterfacePluginField.html#key) [status](models_PluginField.InterfacePluginField.html#status) [value](models_PluginField.InterfacePluginField.html#value)
...
*   Defined in [src/models/PluginField.ts:7](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/PluginField.ts#L7)

### createdAt[](#createdAt)

createdAt: Date

*   Defined in [src/models/PluginField.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/PluginField.ts#L11)

### key[](#key)

key: string

*   Defined in [src/models/PluginField.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/PluginField.ts#L8)

### status[](#status)

status: string

*   Defined in [src/models/PluginField.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/PluginField.ts#L10)

### value[](#value)

value: string

*   Defined in [src/models/PluginField.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/models/PluginField.ts#L9)
...
*   [models/PluginField](../modules/models_PluginField.html)
    ...
    *   [InterfacePluginField](models_PluginField.InterfacePluginField.html)
    *   [PluginField](../variables/models_PluginField.PluginField.html)
