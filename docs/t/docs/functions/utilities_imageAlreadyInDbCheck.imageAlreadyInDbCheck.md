imageAlreadyInDbCheck | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [imageAlreadyInDbCheck](utilities_imageAlreadyInDbCheck.imageAlreadyInDbCheck.html)

Function imageAlreadyInDbCheck
==============================

*   imageAlreadyInDbCheck(oldImagePath, newImagePath): Promise<string\>[](#imageAlreadyInDbCheck)
*   This function checks if an image already exists in the database using hash. If it does, then point to that image and remove the image just uploaded. Else, allow the file to get uploaded.
    ...
    *   Defined in [src/utilities/imageAlreadyInDbCheck.ts:16](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/imageAlreadyInDbCheck.ts#L16)
