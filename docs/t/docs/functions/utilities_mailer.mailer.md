mailer | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [mailer](utilities_mailer.mailer.html)

Function mailer
===============

*   mailer(mailFields): Promise<any\>[](#mailer)
*   This function sends emails to the specified user using the node mailer module.
    
    #### Parameters
    
    *   ##### mailFields: [InterfaceMailFields](../interfaces/utilities_mailer.InterfaceMailFields.html)
    ...
    *   Defined in [src/utilities/mailer.ts:23](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/mailer.ts#L23)
