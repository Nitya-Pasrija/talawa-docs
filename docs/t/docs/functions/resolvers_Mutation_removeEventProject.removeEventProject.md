removeEventProject | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [removeEventProject](resolvers_Mutation_removeEventProject.removeEventProject.html)

Function removeEventProject
===========================

*   removeEventProject(\_parent, args, context): Promise<[InterfaceEventProject](../interfaces/models_EventProject.InterfaceEventProject.html)\>[](#removeEventProject)
*   This function enables to remove an event project.
    ...
    *   ##### context: any
    ...
    #### Returns Promise<[InterfaceEventProject](../interfaces/models_EventProject.InterfaceEventProject.html)\>
    ...
    *   Defined in [src/resolvers/Mutation/removeEventProject.ts:20](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/removeEventProject.ts#L20)
