getSort | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [getSort](resolvers_Query_helperFunctions_getSort.getSort.html)

Function getSort
================

*   getSort(orderBy): any[](#getSort)
*   #### Parameters
    
    *   ##### orderBy: undefined | [InputMaybe](../types/types_generatedGraphQLTypes.InputMaybe.html)<"allDay\_ASC" | "allDay\_DESC" | "description\_ASC" | "description\_DESC" | "endDate\_ASC" | "endDate\_DESC" | "endTime\_ASC" | "endTime\_DESC" | "id\_ASC" | "id\_DESC" | "location\_ASC" | "location\_DESC" | "recurrance\_ASC" | "recurrance\_DESC" | "startDate\_ASC" | "startDate\_DESC" | "startTime\_ASC" | "startTime\_DESC" | "title\_ASC" | "title\_DESC" | "apiUrl\_ASC" | "apiUrl\_DESC" | "name\_ASC" | "name\_DESC" | "commentCount\_ASC" | "commentCount\_DESC" | "createdAt\_ASC" | "createdAt\_DESC" | "imageUrl\_ASC" | "imageUrl\_DESC" | "likeCount\_ASC" | "likeCount\_DESC" | "text\_ASC" | "text\_DESC" | "videoUrl\_ASC" | "videoUrl\_DESC" | "appLanguageCode\_ASC" | "appLanguageCode\_DESC" | "email\_ASC" | "email\_DESC" | "firstName\_ASC" | "firstName\_DESC" | "lastName\_ASC" | "lastName\_DESC" | "deadline\_ASC" | "deadline\_DESC"\>
        
    
    #### Returns any
    
    *   Defined in [src/resolvers/Query/helperFunctions/getSort.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Query/helperFunctions/getSort.ts#L10)
