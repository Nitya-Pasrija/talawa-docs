uploadImage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [uploadImage](utilities_uploadImage.uploadImage.html)

Function uploadImage
====================

*   uploadImage(newImageFile, oldImagePath): Promise<{  
...
*   This function uploads the new image and deletes the previously uploaded image if exists.
    ...
    *   Defined in [src/utilities/uploadImage.ts:16](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/uploadImage.ts#L16)
