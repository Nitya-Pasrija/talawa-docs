createEventProject | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createEventProject](resolvers_Mutation_createEventProject.createEventProject.html)

Function createEventProject
===========================

*   createEventProject(\_parent, args, context): Promise<[InterfaceEventProject](../interfaces/models_EventProject.InterfaceEventProject.html)\>[](#createEventProject)
*   This function enables to create an event project.
    ...
    *   Defined in [src/resolvers/Mutation/createEventProject.ts:20](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Mutation/createEventProject.ts#L20)
