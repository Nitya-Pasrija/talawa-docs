trace | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   trace<T\>(tracingId, method): Promise<void\>[](#trace)
*   #### Type Parameters
    ...
    *   Defined in [src/libraries/requestTracing.ts:50](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/requestTracing.ts#L50)
