createRefreshToken | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [createRefreshToken](utilities_auth.createRefreshToken.html)

Function createRefreshToken
===========================

*   createRefreshToken(user): string[](#createRefreshToken)
*   #### Parameters
    ...
    *   Defined in [src/utilities/auth.ts:34](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/auth.ts#L34)
...
*   [utilities/auth](../modules/utilities_auth.html)
    ...
    *   [createAccessToken](utilities_auth.createAccessToken.html)
    *   [createRefreshToken](utilities_auth.createRefreshToken.html)
