getRequestContextValue | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   getRequestContextValue<T\>(key): T[](#getRequestContextValue)
*   #### Type Parameters
    ...
    *   Defined in [src/libraries/requestContext.ts:18](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/requestContext.ts#L18)
