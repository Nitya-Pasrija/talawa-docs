getEnvIssues | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [getEnvIssues](env.getEnvIssues.html)
...
*   #### Returns void | ZodIssue\[\]
    ...
    *   Defined in [src/env.ts:35](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/env.ts#L35)
