graphqlConnectionFactory | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [graphqlConnectionFactory](utilities_graphqlConnectionFactory.graphqlConnectionFactory.html)

Function graphqlConnectionFactory
=================================

*   graphqlConnectionFactory<T\>(): InterfaceConnection<T\>[](#graphqlConnectionFactory)
*   #### Type Parameters
    ...
    *   Defined in [src/utilities/graphqlConnectionFactory.ts:28](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/graphqlConnectionFactory.ts#L28)
