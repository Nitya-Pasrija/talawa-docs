copyToClipboard | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [copyToClipboard](utilities_copyToClipboard.copyToClipboard.html)

Function copyToClipboard
========================

*   copyToClipboard(text): void[](#copyToClipboard)
*   This utility function copy the text into the clipboard.
    ...
    *   Defined in [src/utilities/copyToClipboard.ts:9](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/copyToClipboard.ts#L9)
