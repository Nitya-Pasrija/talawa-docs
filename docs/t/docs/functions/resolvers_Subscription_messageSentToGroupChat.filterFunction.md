filterFunction | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [filterFunction](resolvers_Subscription_messageSentToGroupChat.filterFunction.html)

Function filterFunction
=======================

*   filterFunction(payload, context): Promise<boolean\>[](#filterFunction)
*   #### Parameters
    ...
    *   Defined in [src/resolvers/Subscription/messageSentToGroupChat.ts:7](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Subscription/messageSentToGroupChat.ts#L7)
