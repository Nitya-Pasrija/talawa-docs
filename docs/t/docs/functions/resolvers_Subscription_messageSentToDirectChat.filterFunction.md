...
*   [filterFunction](resolvers_Subscription_messageSentToDirectChat.filterFunction.html)

Function filterFunction
=======================

*   filterFunction(payload, context): boolean[](#filterFunction)
*   #### Parameters
    ...
    *   Defined in [src/resolvers/Subscription/messageSentToDirectChat.ts:6](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/resolvers/Subscription/messageSentToDirectChat.ts#L6)
