deletePreviousImage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [deletePreviousImage](utilities_encodedImageStorage_deletePreviousImage.deletePreviousImage.html)

Function deletePreviousImage
============================

*   deletePreviousImage(imageToBeDeletedPath): Promise<void\>[](#deletePreviousImage)
*   #### Parameters
    ...
    *   Defined in [src/utilities/encodedImageStorage/deletePreviousImage.ts:5](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/encodedImageStorage/deletePreviousImage.ts#L5)
