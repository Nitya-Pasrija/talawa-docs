createAccessToken | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   createAccessToken(user): string[](#createAccessToken)
*   This function creates a json web token which expires in 15 minutes. It signs the given payload(user data) into a JSON Web Token string payload.
    ...
    *   Defined in [src/utilities/auth.ts:18](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/auth.ts#L18)
