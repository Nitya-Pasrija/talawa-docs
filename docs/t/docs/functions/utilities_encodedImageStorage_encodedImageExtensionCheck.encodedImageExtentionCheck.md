encodedImageExtentionCheck | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [encodedImageExtentionCheck](utilities_encodedImageStorage_encodedImageExtensionCheck.encodedImageExtentionCheck.html)

Function encodedImageExtentionCheck
===================================

*   encodedImageExtentionCheck(encodedUrl): boolean[](#encodedImageExtentionCheck)
*   #### Parameters
