connect | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   #### Returns Promise<void\>
    ...
    *   Defined in [src/db.ts:5](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/db.ts#L5)
