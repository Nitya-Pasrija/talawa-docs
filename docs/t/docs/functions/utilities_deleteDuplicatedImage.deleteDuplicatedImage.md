deleteDuplicatedImage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [deleteDuplicatedImage](utilities_deleteDuplicatedImage.deleteDuplicatedImage.html)

Function deleteDuplicatedImage
==============================

*   deleteDuplicatedImage(imagePath): void[](#deleteDuplicatedImage)
*   This function deletes a duplicated image using the function fs.unlink().
    ...
    *   Defined in [src/utilities/deleteDuplicatedImage.ts:8](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/deleteDuplicatedImage.ts#L8)
