setTracingId | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [setTracingId](libraries_requestTracing.setTracingId.html)

Function setTracingId
=====================

*   setTracingId(tracingId): string[](#setTracingId)
*   #### Parameters
    ...
    *   Defined in [src/libraries/requestTracing.ts:25](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/requestTracing.ts#L25)
...
*   [libraries/requestTracing](../modules/libraries_requestTracing.html)
    ...
    *   [getTracingId](libraries_requestTracing.getTracingId.html)
    *   [middleware](libraries_requestTracing.middleware.html)
    *   [setTracingId](libraries_requestTracing.setTracingId.html)
    *   [trace](libraries_requestTracing.trace.html)
