...
*   middleware(): ((req, res, next) => void)[](#middleware)
*   #### Returns ((req, res, next) => void)
    ...
    *   Defined in [src/libraries/requestContext.ts:27](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/requestContext.ts#L27)
