uploadEncodedImage | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [uploadEncodedImage](utilities_encodedImageStorage_uploadEncodedImage.uploadEncodedImage.html)

Function uploadEncodedImage
===========================

*   uploadEncodedImage(encodedImageURL, previousImagePath?): Promise<string\>[](#uploadEncodedImage)
*   #### Parameters
    
    *   ##### encodedImageURL: string
        
    *   ##### `Optional` previousImagePath: null | string
        
    
    #### Returns Promise<string\>
    
    *   Defined in [src/utilities/encodedImageStorage/uploadEncodedImage.ts:11](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/encodedImageStorage/uploadEncodedImage.ts#L11)
