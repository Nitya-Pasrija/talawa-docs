imageExtensionCheck | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [imageExtensionCheck](utilities_imageExtensionCheck.imageExtensionCheck.html)

Function imageExtensionCheck
============================

*   imageExtensionCheck(filename): Promise<void\>[](#imageExtensionCheck)
*   This function checks the extension of the file. If the extension isn't of type 'png', or 'jpg', or 'jpeg', then the file is deleted and a validation error is thrown.
    ...
    *   Defined in [src/utilities/imageExtensionCheck.ts:10](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/imageExtensionCheck.ts#L10)
