adminCheck | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [adminCheck](utilities_adminCheck.adminCheck.html)

Function adminCheck
===================

*   adminCheck(userId, organization): Promise<void\>[](#adminCheck)
*   If the current user is an admin of the organisation, this function returns `true` otherwise it returns `false`.
    ...
    *   Defined in [src/utilities/adminCheck.ts:14](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/adminCheck.ts#L14)
