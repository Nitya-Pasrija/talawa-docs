reuploadDuplicateCheck | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [reuploadDuplicateCheck](utilities_reuploadDuplicateCheck.reuploadDuplicateCheck.html)

Function reuploadDuplicateCheck
===============================

*   reuploadDuplicateCheck(oldImagePath, newImagePath): Promise<boolean\>[](#reuploadDuplicateCheck)
*   This function determines whether a user or an organisation is attempting to re-upload the same profile photo or organisation image.
    ...
    *   ##### oldImagePath: null | [TypeImagePath](../types/utilities_reuploadDuplicateCheck.TypeImagePath.html)
        
        Path of a current Org/User image of `type: TypeImagePath`.
        
    *   ##### newImagePath: [TypeImagePath](../types/utilities_reuploadDuplicateCheck.TypeImagePath.html)
    ...
    *   Defined in [src/utilities/reuploadDuplicateCheck.ts:42](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/utilities/reuploadDuplicateCheck.ts#L42)
