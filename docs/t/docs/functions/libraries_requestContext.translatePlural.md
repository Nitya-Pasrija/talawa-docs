translatePlural | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   translatePlural(...args): any[](#translatePlural)
*   #### Parameters
    ...
    *   Defined in [src/libraries/requestContext.ts:70](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/requestContext.ts#L70)
