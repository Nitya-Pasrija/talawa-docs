setRequestContext | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   setRequestContext(obj): void[](#setRequestContext)
*   #### Parameters
    ...
    *   Defined in [src/libraries/requestContext.ts:22](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/requestContext.ts#L22)
