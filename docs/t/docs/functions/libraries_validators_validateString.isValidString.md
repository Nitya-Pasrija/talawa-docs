isValidString | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [isValidString](libraries_validators_validateString.isValidString.html)
