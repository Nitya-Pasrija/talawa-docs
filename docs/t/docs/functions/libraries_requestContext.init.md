init | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   #### Type Parameters
    ...
    *   Defined in [src/libraries/requestContext.ts:44](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/requestContext.ts#L44)
