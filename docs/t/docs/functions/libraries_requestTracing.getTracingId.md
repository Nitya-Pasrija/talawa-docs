getTracingId | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   #### Returns string
    ...
    *   Defined in [src/libraries/requestTracing.ts:29](https://github.com/Nitya-Pasrija/talawa-api/blob/1d500f2/src/libraries/requestTracing.ts#L29)
