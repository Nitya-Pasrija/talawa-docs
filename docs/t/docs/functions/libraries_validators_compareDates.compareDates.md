compareDates | talawa-apidocument.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"
...
*   [compareDates](libraries_validators_compareDates.compareDates.html)

Function compareDates
=====================

*   compareDates(date1, date2): string[](#compareDates)
*   #### Parameters
