...
[src/resolvers/Query/postsByOrganizationConnection.ts:19](https://github.com/Nitya-Pasrija/talawa-api/blob/faae1c9/src/resolvers/Query/postsByOrganizationConnection.ts#L19)
