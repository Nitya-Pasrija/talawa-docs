...
[src/utilities/auth.ts:18](https://github.com/Nitya-Pasrija/talawa-api/blob/d3a6af9/src/utilities/auth.ts#L18)
...
[src/utilities/auth.ts:34](https://github.com/Nitya-Pasrija/talawa-api/blob/d3a6af9/src/utilities/auth.ts#L34)
