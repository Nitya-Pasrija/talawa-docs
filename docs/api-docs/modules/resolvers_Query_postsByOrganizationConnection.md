...
[src/resolvers/Query/postsByOrganizationConnection.ts:19](https://github.com/Nitya-Pasrija/talawa-api/blob/d3a6af9/src/resolvers/Query/postsByOrganizationConnection.ts#L19)
